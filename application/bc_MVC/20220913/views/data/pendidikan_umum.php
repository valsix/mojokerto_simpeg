...
$arrdata= array(
    ...
    , array("label"=>"Tempat Sekolah", "field"=> "TEMPAT", "display"=>"",  "width"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpendidikanumum";
    ...
    $("#btnAdd").on("click", function () {
       var url = "data/index/pendidikan_umum_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpendidikanumumdelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "data/index/pendidikan_umum";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pendidikan_umum_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
