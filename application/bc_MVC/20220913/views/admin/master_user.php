...
$arrdata= array(
    ...
    , array("label"=>"User Login", "field"=> "USER_LOGIN", "display"=>"",  "width"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-admin/user_json/json";
    ...
    $("#btnAdd,#btnUbahData").on("click", function () {
        ...
        var infourl= "admin/index/master_user_add";
        if(btnid == "btnAdd"){}
        else
        {
            if(valinfoid == "")
    ...
    $("#btnReset").on("click", function () {
        ...
        var infourl= "admin/index/master_user_reset";
        if(btnid == "btnAdd"){}
        else
        {
            if(valinfoid == "")
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-admin/user_json/delete?&reqId="+valinfoid;
            swal.fire({
