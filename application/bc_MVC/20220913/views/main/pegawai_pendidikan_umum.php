...
$arrtabledata= array(
    ...
    , array("label"=>"Jurusan", "field"=> "NAMA_JURUSAN", "display"=>"",  "width"=>"")
    , array("label"=>"Nama Sekolah", "field"=> "NAMA_SEKOLAH", "display"=>"",  "width"=>"")
    , array("label"=>"Tahun Lulus", "field"=> "TAHUN", "display"=>"",  "width"=>"")
    , array("label"=>"Kategori", "field"=> "TINGKAT_PENDIDIKAN_NAMA", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "RIWAYAT_PENDIDIKAN_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/info_data_json/jsonpendidikanriwayat";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/info_data_json/jsonpendidikanriwayatdelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/pegawai_pendidikan_umum";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/pegawai_pendidikan_umum_add?reqRowId="+vpilihid;
    ...
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           var formSubmitButton = KTUtil.getById('ktloginformsubmitbutton');
               ...
               $.ajax({
                url: 'json-data/info_data_json/jsonpendidikanriwayatupload', 
                dataType: 'json', 
                cache: false,
                contentType: false,
                processData: false,
...
function btnDeleteFile (fileid,reqPegawaiId,reqRowId,reqMode) {
    if(fileid !== "")
    {
        urlAjax= "json-data/info_data_json/jsonpendidikanriwayatdeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqRowId="+reqRowId+"&reqMode="+reqMode;
        swal.fire({
