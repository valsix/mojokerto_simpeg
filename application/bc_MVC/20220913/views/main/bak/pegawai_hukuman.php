...
$arrdata= array(
    ...
    , array("label"=>"Tingkat Hukuman", "field"=> "NMTINGKATHUKUMAN", "display"=>"",  "width"=>"")
    , array("label"=>"Jenis Hukuman", "field"=> "NMJENISHUKUMAN", "display"=>"",  "width"=>"")
    , array("label"=>"Permasalahan", "field"=> "KETERANGAN", "display"=>"",  "width"=>"")
    , array("label"=>"Pejabat Penetap", "field"=> "PEJABAT_PENETAP", "display"=>"",  "width"=>"")
    , array("label"=>"Masih Berlaku", "field"=> "STATUS_BERLAKU", "display"=>"",  "width"=>"")
    , array("label"=>"Keterangan", "field"=> "UPLOAD", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "HUKUMAN_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonpegawaihukuman";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_hukuman_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsonriwayathukumandelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/pegawai_hukuman";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/pegawai_hukuman_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
function btnDeleteFile (fileid,reqPegawaiId,reqDetilId,reqRowId) {
    if(fileid !== "")
    {
        urlAjax= "json-validasi/personal_json/jsonpegawaihukumandeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqDetilId="+reqDetilId+"&reqRowId="+reqRowId;
        swal.fire({
...
function btnUpload(reqDetilId,reqPegawaiId,reqRowId)
{
    $("#reqLinkFile").click();
...
jQuery(document).ready(function(){
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           $.ajax({
            url: 'json-validasi/personal_json/jsonpegawaihukumanupload', 
            dataType: 'json', 
            cache: false,
            contentType: false,
            processData: false,
