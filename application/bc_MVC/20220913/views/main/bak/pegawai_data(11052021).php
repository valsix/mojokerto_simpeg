	        	...
	        	<div class="card-body">
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<input type="text" class="form-control" placeholder="Masukkan NIP lama"name="reqNipLama" id="reqNipLama" value="<?=$reqNipLama?>" />
	        			</div>
	        			<label class="col-form-label text-right col-lg-2 col-sm-12">NIP Baru</label>
	        			<div class="col-lg-4 col-sm-12">
	        				<input type="text" class="form-control" placeholder="Masukkan NIP baru" name="reqNipBaru" id="reqNipBaru" value="<?=$reqNipBaru?>" />
	        			</div>
	        		</div>
	        		<div class="form-group row">
	        			<label class="col-form-label text-right col-lg-2 col-sm-12">Nama</label>
	        			<div class="col-lg-4 col-sm-12">
	        				<input type="text" class="form-control" name="reqNama" id="reqNama" placeholder="Masukkan nama anda" value="<?=$reqNama?>" />
	        			</div>
	        			<label class="col-form-label text-right col-lg-2 col-sm-12">
		        			Agama
		        			<?
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<select class="form-control select2 <?=$valAgamaId['warna']?>" id="ktagamaid" name="reqAgamaId">
	        					<option value=""></option>
	        					<?
	        					// $reqAgamaId= "1";
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<input type="text" class="form-control" placeholder="Masukkan gelar depan" name="reqGelarDepan"  id="reqGelarDepan" value="<?=$reqGelarDepan?>" />
	        			</div>
	        			<label class="col-form-label text-right col-lg-2 col-sm-12">Gelar Belakang</label>
	        			<div class="col-lg-4 col-sm-12">
	        				<input type="text" class="form-control" placeholder="Masukkan gelar belakang" name="reqGelarBelakang" id="reqGelarBelakang" value="<?=$reqGelarBelakang?>" />
	        			</div>
	        		</div>
	        		<div class="form-group row">
	        			<label class="col-form-label text-right col-lg-2 col-sm-12">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<div class="input-group date">
		        				<input type="text" class="form-control <?=$valTanggalLahir['warna']?>" id="kttanggallahir" name="reqTanggalLahir" readonly="readonly" placeholder="Select date" value="<?=$reqTanggalLahir?>" />
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<div class="input-group date">
		        				<input type="text" class="form-control" id="kttanggalpensiun" name="reqTglPensiun" readonly="readonly" placeholder="Select date" value="<?=$reqTglPensiun?>" />
		        				<div class="input-group-append">
		        					<span class="input-group-text">
		        						<i class="la la-calendar"></i>
		        					</span>
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<!-- <input type="text" class="form-control" name="reqKonversiNIP" id="reqKonversiNIP" style="width:150px;" value="<?=$reqKonversiNIP?>" />
	        				<? 
