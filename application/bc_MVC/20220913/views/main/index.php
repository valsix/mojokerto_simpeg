...
$index_set=0;
$arrMenu= [];
$arrparam= ["mode"=>"personal", "formulaid"=>$formulaid];
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            ...
                            <ul class="menu-nav">
                                ...
                                <?
                                function getMenuByParent($id_induk, $arrMenu, $tempParentNama, $formulaid, $pg)
                                {
                                    $arrayKey= [];
                                    ...
                                    if(!empty($arrayKey))
                                    {
                                        for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
                                        {
                                            ...
                                            if(!empty($formulaid))
                                                $tempLinkFile.= "?formulaid=".$formulaid;
                                ?>
                                ...
                                <li class="menu-item menu-item-submenu <?=$menuopen?> menu-item-here" aria-haspopup="true" data-menu-toggle="hover">
                                    ...
                                    <div class="menu-submenu">
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            {
                                                getMenuByParent($tempMenuId, $arrMenu, $tempNama, $formulaid, $pg);
                                            ?>
                                            <?
                                            }
                                            ?>
