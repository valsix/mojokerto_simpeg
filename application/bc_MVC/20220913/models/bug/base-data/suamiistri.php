  ...
  class SuamiIstri extends Entity{ 
    ...
    function insert()
	{
		...
		$str = "INSERT INTO SUAMI_ISTRI ( 
				   ...
				   STATUS_BAYAR, BULAN_BAYAR, STATUS, LAST_CREATE_USER, LAST_CREATE_DATE, LAST_CREATE_SATKER)
				VALUES (
     ...
     function insertupload()
	{
		...
		$str = "INSERT INTO SUAMI_ISTRI_FILE(
	            SUAMI_ISTRI_FILE_ID,SUAMI_ISTRI_ID, PEGAWAI_ID,  
    ...
    function updateupload($nama,$link)
	{
		$str = "
				...
				SET    
					   SUAMI_ISTRI_FILE_ID= ".$this->getField("SUAMI_ISTRI_FILE_ID").",
					   ".$nama."= '".$this->getField($nama)."',
