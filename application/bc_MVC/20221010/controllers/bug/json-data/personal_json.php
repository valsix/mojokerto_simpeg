...
class personal_json extends CI_Controller {
			...
			if(count($errors) === 0) 
			{
				...
				if(move_uploaded_file($reqLinkFile, $dest_path))
				{
					...
					else
					{
						...
						if($set_upload->updateuploadfoto())
						{
							$reqSimpan= 1;
						}
					}
	...
	function jsonpegawaicpnsdeletefile()
	{
		$this->load->model("base-data/SkCpns");
		$reqFileId= $this->input->get("reqFileId");
		$reqPegawaiId= $this->input->get("reqPegawaiId");
		...
		$set= new SkCpns();
		$set->setField('SK_CPNS_FILE_ID', $reqFileId);
		$set->setField('PEGAWAI_ID', $reqPegawaiId);

		$set_upload = new SkCpns();
		
		$set_upload->selectByParams(array('A.SK_CPNS_ID'=>$reqRowId));
	...
	function jsonpegawaiskpnsadd()
	{
		...
		if(!empty($fileName) || !empty($fileNameBerita) || !empty($fileNameSurat) || !empty($fileNameSpmt))
		{
			...
			if(($_FILES['reqLinkFile']['size'] >= $maxsize) || ($_FILES['reqLinkFileBerita']['size'] >= $maxsize) || ($_FILES['reqLinkFileSurat']['size'] >= $maxsize) || ($_FILES['reqLinkFileSpmt']['size'] >= $maxsize) ) 
			{
				$errors[] = 'File terlalu besar. <br> Pastikan ukuran file tidak lebih dari 2 MB';
			}
	...
	function jsonpegawaipnsdeletefile()
	{
		$this->load->model("base-data/SkPns");
		$reqFileId= $this->input->get("reqFileId");
		$reqPegawaiId= $this->input->get("reqPegawaiId");
		...
		$set_upload->selectByParamsAdmin(array('A.SK_PNS_ID'=>$reqRowId));
		
		$set_upload->firstRow();
		$reqLinkFile= $set_upload->getField('LINK_FILE');
		$reqLinkFileBerita= $set_upload->getField('LINK_FILE_BERITA');
		$reqLinkFileSurat= $set_upload->getField('LINK_FILE_SURAT');
		$reqLinkFileSpmt= $set_upload->getField('LINK_FILE_SPMT');

		$set= new SkPns();
		$set->setField('SK_PNS_FILE_ID', $reqFileId);
		$set->setField('PEGAWAI_ID', $reqPegawaiId);
		...
		if($reqMode=="berita")
		{
			$set->setField('LINK_FILE_BERITA', "");
			$kolom="LINK_FILE_BERITA";
			$nama="NAMA_FILE_BERITA";
			
			if(file_exists($reqLinkFileBerita))
			{
				unlink($reqLinkFileBerita);
			}
		}
		elseif($reqMode=="surat")
		{
			$set->setField('LINK_FILE_SURAT',"");
			$kolom="LINK_FILE_SURAT";
			$nama="NAMA_FILE_SURAT";
			if(file_exists($reqLinkFileSurat))
			{
				unlink($reqLinkFileSurat);
			}
			
		}
		elseif($reqMode=="spmt")
		{
			$set->setField('LINK_FILE_SPMT',"");
			$kolom="LINK_FILE_SPMT";
			$nama="NAMA_FILE_SPMT";
			if(file_exists($reqLinkFileSpmt))
			{
				unlink($reqLinkFileSpmt);
			}
		}
		else
		{
		...
		if($set->deletefileupdate($kolom,$nama))	
		{	
			$reqSimpan=1;
		}
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					...
					if(!empty($reqLinkFileSk))
					{
						$reqMode="pangkat_sk";
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=pangkat_sk&reqFileId='.$reqFileId.'" target="_blank">
				...
				{ 
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=pangkat_stlud&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=gaji&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
	...
	function jsonriwayatgajideletefile()
	{
		...
		$set_upload->selectByParamsAdmin(array('A.GAJI_RIWAYAT_ID'=>$reqRowId));
	...
	function jsonpegawaisuamiistri()
	{
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					$row[$valkey]= '
					<a class="navi-link" onclick=\'btnUploadAkta("'.$reqPegawaiId.'","'.$reqRowId.'");\'>
					<img src="images/upload.png" title="upload" style="width:20px;height:20px">
					</a>
					&nbsp;
					';
					...
					if(!empty($reqLinkFileAkta))
					{
						$reqMode="akta";
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=akta&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
				...
				{ 
					$reqMode="kk";
					$row[$valkey]= '
					<a class="navi-link" onclick=\'btnUploadKK("'.$reqPegawaiId.'","'.$reqRowId.'");\'>
					<img src="images/upload.png" title="upload" style="width:20px;height:20px">
					</a>
					&nbsp;
					';
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=kk&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
				...
				{ 
					$reqMode="ktp";
					$row[$valkey]= '
					<a class="navi-link" onclick=\'btnUploadKtp("'.$reqPegawaiId.'","'.$reqRowId.'");\'>
					<img src="images/upload.png" title="upload" style="width:20px;height:20px">
					</a>
					&nbsp;
					';
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=ktp&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=anak&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
	...
	function jsonpegawaipenghargaan()
	{
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					$row[$valkey]= '
					<a class="navi-link" onclick=\'btnUpload("'.$reqPegawaiId.'","'.$reqTahun.'","'.$reqRowId.'");\'>
					<img src="images/upload.png" title="upload" style="width:20px;height:20px">
					</a>
					&nbsp;
					';
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=penghargaan&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=hukuman&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
	...
	function jsonpegawaikursus()
	{
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					$row[$valkey]= '
					<a class="navi-link" onclick=\'btnUpload("'.$reqPegawaiId.'","'.$reqJenisJabatanId.'","'.$reqRowId.'");\'>
					<img src="images/upload.png" title="upload" style="width:20px;height:20px">
					</a>
					&nbsp;
					';
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=kursus&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
	...
	function jsonpegawaidiklat()
	{
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					$row[$valkey]= '
					<a class="navi-link" onclick=\'btnUpload("'.$reqPegawaiId.'","'.$reqRowId.'","'.$reqDiklatId.'");\'>
					<img src="images/upload.png" title="upload" style="width:20px;height:20px">
					</a>
					&nbsp;
					';
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=diklat&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
	...
	function jsonpegawaijabatantipe()
	{
		...
		while ($set->nextRow()) 
		{
			...
			$unornew = $set->getField("SATKER_INDUK_NAMA");
			$subnew = $set->getField("SATKER");
			$reqLinkFile = $set->getField("LINK_FILE");
			$reqPegawaiId = $this->pegawaiId;
			...
			$reqJenisJabatanId = $set->getField("JENIS_JABATAN_ID");
			$reqLinkFileServer = $set->getField("LINK_SERVER");
			// print_r($reqLinkFileServer );exit;
			$row= [];
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=jabatan&reqPegawaiJabatanFileId='.$reqPegawaiJabatanFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
						...
						$row[$valkey].= '
						<a class="navi-link" onclick=\'btnDeleteFile("'.$reqPegawaiJabatanFileId.'","'.$reqPegawaiId.'","'.$reqRowId.'");\'>
						<img src="images/delete-icon.png" title="delete" style="width:20px;height:20px">
						</a>
						';
					}
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=riwayat_kontrak&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=pendidikan&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
	...
	function jsonpegawaipendidikanupload()
	{
		$this->load->model("base-data/PegawaiPendidikanRiwayat");
		$reqPegawaiId= $this->input->post("reqPegawaiId");
		$reqRowId= $this->input->post("reqRowId");
	...
	function jsonpegawaiskp()
	{
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{ 
					$row[$valkey]= '
					<a class="navi-link" onclick=\'btnUpload("'.$reqPegawaiId.'","'.$reqRowId.'","'.$reqTahun.'");\'>
					<img src="images/upload.png" title="upload" style="width:20px;height:20px">
					</a>
					&nbsp;
					';
					...
					{
						$row[$valkey].= '
						<a class="navi-link" href="admin/loadUrl/admin/viewer?reqForm=skp&reqFileId='.$reqFileId.'" target="_blank">
						<img src="images/download.png" title="download" style="width:20px;height:20px">
						</a>
						&nbsp;
						';
