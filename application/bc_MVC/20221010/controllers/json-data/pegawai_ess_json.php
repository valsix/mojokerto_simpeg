...
class pegawai_ess_json extends CI_Controller {
	...
	function json()
	{
		...
		$set->selectbyPegawaiEss(array(), $displaylength, $displaystart, $statement);
		// echo $set->query;exit;
		while ($set->nextRow()) 
		{
	...
	function add()
	{
		...
		if($reqNilai>100){
			echo json_response(400, 'Nilai Tidak Boleh Lebih Dari 100'); exit;
		}
		...
		$set->setField("RIWAYAT_Ess_ID", $reqId);
