<? 
  ...
  class Hukuman extends Entity{ 
    ...
    function insert()
	{
		$this->setField("TEMP_VALIDASI_ID", $this->getNextId("TEMP_VALIDASI_ID","validasi.HUKUMAN")); 
		
		$str = "INSERT INTO validasi.HUKUMAN (
				   ...
				   TANGGAL_MULAI, TANGGAL_AKHIR, LAST_CREATE_USER, LAST_CREATE_DATE, LAST_CREATE_SATKER, TEMP_VALIDASI_ID)
				VALUES (
    ...
    function insertupload()
	{
		...
		$str = "INSERT INTO HUKUMAN_FILE(
	            HUKUMAN_FILE_ID, HUKUMAN_ID, PEGAWAI_ID, TEMP_VALIDASI_ID, 
    ...
    function delete()
	{
        $str = "DELETE FROM validasi.HUKUMAN
                WHERE 
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder="")
	{
		...
		SELECT 
		   ...
		   ,COALESCE(PJ.LINK_FILE,PA.LINK_FILE) LINK_FILE,COALESCE(PJ.HUKUMAN_FILE_ID,PA.HUKUMAN_FILE_ID)HUKUMAN_FILE_ID,COALESCE(PJ.LINK_SERVER,PA.LINK_SERVER)LINK_SERVER
        ...
        LEFT JOIN HUKUMAN_FILE PJ ON PJ.TEMP_VALIDASI_ID = A.TEMP_VALIDASI_ID
		LEFT JOIN HUKUMAN_FILE PA ON PA.HUKUMAN_ID = A.HUKUMAN_ID
        WHERE 1 = 1
		"; 
	...
	{
		$str = "
		SELECT A.HUKUMAN_FILE_ID, A.HUKUMAN_ID, A.PEGAWAI_ID, A.TEMP_VALIDASI_ID, 
		A.NAMA_FILE, A.LINK_FILE, A.TIPE_FILE,A.LINK_SERVER
		FROM HUKUMAN_FILE A
		LEFT JOIN validasi.HUKUMAN B ON A.TEMP_VALIDASI_ID = B.TEMP_VALIDASI_ID
		WHERE 1=1
		"; 
