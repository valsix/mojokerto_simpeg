  ...
  class Penghargaan extends Entity{ 
    ...
    function insertupload()
	{
		...
		$str = "INSERT INTO PENGHARGAAN_FILE(
	            PENGHARGAAN_FILE_ID, PENGHARGAAN_ID, PEGAWAI_ID, 
	...
	{
		$str = "
		SELECT A.PENGHARGAAN_ID, A.PEGAWAI_ID, 
		...
		, K.LINK_FILE
		, K.PENGHARGAAN_FILE_ID,K.LINK_SERVER
		FROM PENGHARGAAN A
		LEFT JOIN PEJABAT_PENETAP B ON (A.PEJABAT_PENETAP_ID = B.PEJABAT_PENETAP_ID)
		LEFT JOIN PENGHARGAAN_FILE K ON K.PENGHARGAAN_ID = A.PENGHARGAAN_ID
		WHERE 1 = 1
		"; 
	...
	{
		$str = "
		SELECT A.PENGHARGAAN_FILE_ID, A.PENGHARGAAN_ID, A.PEGAWAI_ID, 
		A.NAMA_FILE, A.LINK_FILE, A.TIPE_FILE,A.LINK_SERVER
		FROM PENGHARGAAN_FILE A
		INNER JOIN PENGHARGAAN B ON A.PENGHARGAAN_ID = B.PENGHARGAAN_ID
		WHERE 1=1
		"; 
