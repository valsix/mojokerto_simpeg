        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Export Data Diklat</h3>
                </div>
...
jQuery(document).ready(function() {
    ...
    var jsonurl= "json-admin/export_json/jsonpegawaidiklat?reqBulan=<?=$reqBulan?>&reqTahun=<?=$reqTahun?>";
    ...
    $("#reqExcel").click(function() {
        ...
        urlExcel= "admin/loadUrl/admin/export_diklat?reqBulan="+reqBulan+"&reqTahun="+reqTahun;
