            ...
            <form class="form" id="ktloginform" method="POST" enctype="multipart/form-data">
	        	<div class="card-body">
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<div class="input-group date">
		        				<input type="text" class="form-control <?=$valTanggalLahir['warna']?>" id="kttanggallahir"   placeholder="Select date" value="<?=$reqTanggalLahir?>" />
		        				<input type="hidden" name="reqTanggalLahir" value="<?=$reqTanggalLahir?>" />
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<div class="input-group date">
		        				<input type="text" class="form-control" id="kttanggalpensiun" readonly placeholder="Select date" value="<?=$reqTglPensiun?>" />
		        				<input type="hidden" name="reqTglPensiun" value="<?=$reqTglPensiun?>" />
		        				<div class="input-group-append">
		        					<span class="input-group-text">
		        						<i class="la la-calendar"></i>
		        					</span>
