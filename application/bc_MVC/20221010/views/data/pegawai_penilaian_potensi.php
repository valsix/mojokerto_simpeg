...
$arrdata= array(
    ...
    , array("label"=>"Tanggung Jawab", "field"=> "TANGGUNG_JAWAB", "display"=>"",  "width"=>"")
    , array("label"=>"Motivasi", "field"=> "MOTIVASI", "display"=>"",  "width"=>"")
    , array("label"=>"Minat", "field"=> "MINAT", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "POTENSI_DIRI_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpegawaipotensidiri";
    ...
    $("#btnAdd").on("click", function () {
       var url = "data/index/pegawai_penilaian_potensi_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpegawaipenilaiandelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "data/index/pegawai_penilaian_potensi";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pegawai_penilaian_potensi_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
