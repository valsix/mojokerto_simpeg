...
$arrdata= array(
    ...
    , array("label"=>"No. Piagam", "field"=> "NO_PIAGAM", "display"=>"", "width"=>"")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Seminar</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonpegawaiseminar";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_seminar_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsonpegawaiseminardelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/pegawai_seminar_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
