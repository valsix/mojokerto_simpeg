	        	...
	        	<div class="card-footer">
	        		<div class="row">
	        			<div class="col-lg-9">
	        				...
	        				{
	        				?>
	        					<a class="btn btn-success font-weight-bold mr-2" href="admin/loadUrl/admin/viewer?reqForm=diklat&reqFileId=<?=$reqFileId?>" target="_blank">Download</a>
...
<script type="text/javascript">
	...
	function kembali() {
		window.location.href='data/index/pegawai_diklat'
	}
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-data/personal_json/jsonpegawaidiklatadd";
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "data/index/pegawai_diklat";
	...
	function btndeletefile(fileid,reqPegawaiId,reqRowId) {
		if(fileid !== "")
        {
            urlAjax= "json-data/personal_json/jsonpegawaidiklatdeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqRowId="+reqRowId;
            swal.fire({
