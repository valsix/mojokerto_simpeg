...
$arrdata= array(
    ...
    , array("label"=>"Selesai Kontrak", "field"=> "SELESAI_KONTRAK", "display"=>"",  "width"=>"")
    , array("label"=>"Masa Berlaku", "field"=> "MASA_BERLAKU_TAHUN", "display"=>"",  "width"=>"")
    , array("label"=>"Masa Kerja", "field"=> "MASA_KERJA", "display"=>"",  "width"=>"")
    , array("label"=>"Golongan PPPK", "field"=> "KODE", "display"=>"",  "width"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpegawaikontrak";
    ...
    $("#btnAdd").on("click", function () {
       var url = "data/index/pegawai_riwayat_kontrak_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpegawaikontrakdelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "data/index/pegawai_riwayat_kontrak";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pegawai_riwayat_kontrak_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
function btnUpload(reqPegawaiId,reqRowId)
{
    $("#reqLinkFile").click();
    ...
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           var formSubmitButton = KTUtil.getById('ktloginformsubmitbutton');
               ...
               $.ajax({
                url: 'json-data/personal_json/jsonpegawaikontrakupload', 
                dataType: 'json', 
                cache: false,
                contentType: false,
                processData: false,
...
function btnDeleteFile (fileid,reqPegawaiId,reqRowId) {
    if(fileid !== "")
    {
        urlAjax= "json-data/personal_json/jsonpegawaikontrakdeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqRowId="+reqRowId;
        swal.fire({
