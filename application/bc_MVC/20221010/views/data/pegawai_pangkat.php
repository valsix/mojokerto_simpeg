...
$arrdata= array(
    ...
    , array("label"=>"File SK", "field"=> "SK", "display"=>"", "width"=>"")
    // , array("label"=>"File STLUD", "field"=> "STLUD", "display"=>"", "width"=>"")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Riwayat Pangkat / Golongan</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpangkatriwayat";
    ...
    $("#btnAdd").on("click", function () {
       var url = "data/index/pegawai_pangkat_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpangkatriwayatdelete?&reqDetilId="+valinfoid;
            swal.fire({
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pegawai_pangkat_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
    });
    ...
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           var formSubmitButton = KTUtil.getById('ktloginformsubmitbutton');
               ...
               $.ajax({
                url: 'json-data/personal_json/jsonpangkatriwayatupload', 
                dataType: 'json', 
                cache: false,
                contentType: false,
                processData: false,
...
function btnDeleteFile (fileid,reqPegawaiId,reqRowId,reqMode) {
    if(fileid !== "")
    {
        urlAjax= "json-data/personal_json/jsonpangkatriwayatdeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqRowId="+reqRowId+"&reqMode="+reqMode;
        swal.fire({
