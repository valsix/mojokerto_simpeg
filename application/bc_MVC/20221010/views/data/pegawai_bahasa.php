...
$arrdata= array(
    array("label"=>"Jenis Bahasa", "field"=> "NMJENIS", "display"=>"",  "width"=>"")
    , array("label"=>"Nama Bahasa", "field"=> "NAMA", "display"=>"",  "width"=>"")
    , array("label"=>"Kemampuan Bicara", "field"=> "MAMPU", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "BAHASA_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Penguasaan Bahasa</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Penguasaan Bahasa</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpegawaibahasa";
    ...
    $("#btnAdd").on("click", function () {
       var url = "data/index/pegawai_bahasa_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpegawaibahasadelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "data/index/pegawai_bahasa";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pegawai_bahasa_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
