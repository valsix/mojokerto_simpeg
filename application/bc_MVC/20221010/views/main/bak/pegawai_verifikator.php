...
$arrdata= array(
    ...
    // , array("label"=>"Status Pegawai", "field"=> "STATUS_PEGAWAI_NAMA", "display"=>"",  "width"=>"")
    , array("label"=>"Riwayat Jenis", "field"=> "INFO_JENIS", "display"=>"",  "width"=>"")
    , array("label"=>"Jenis Update", "field"=> "INFO_JENIS_UPDATE", "display"=>"",  "width"=>"")
    , array("label"=>"Status", "field"=> "INFO_STATUS", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldvalidasi", "field"=> "INFO_VALIDASI", "display"=>"1", "width"=>"")
    , array("label"=>"fieldlink", "field"=> "INFO_LINK", "display"=>"1", "width"=>"")
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Data Verifikator</a>
                    </li>
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Verifikator</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Verifikator</h3>
                </div>
...
var indexlink= arrdata.length - 5;
var indexinfovalidasi= arrdata.length - 6;

var valinfoid = '';
var valinfovalidasiid = '';
var valinfovalidasihapusid = '';
var valinfovalidasilink = '';
var valinfovalidasi = '';

jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/pegawaiverifikator";
    ...
    $('#'+infotableid+' tbody').on( 'click', 'tr', function () {
        ...
        fieldvalidasilink= arrdata[indexlink]["field"]
        fieldinfovalidasi= arrdata[indexinfovalidasi]["field"]
        if (dataselected)
        {
            valinfoid= dataselected[fieldinfoid];
            valinfovalidasiid= dataselected[fieldvalidasiid];
            valinfovalidasihapusid= dataselected[fieldvalidasihapusid];
            valinfovalidasilink= dataselected[fieldvalidasilink];
            valinfovalidasi= dataselected[fieldinfovalidasi];
        }
        // console.log(valinfovalidasi);
        if (valinfovalidasiid == null)
        {
            valinfovalidasiid = '';
        }

        if (valinfovalidasi == null)
        {
            valinfovalidasi = '';
        }
    });
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_verifikator_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/pegawaiverifikatordelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/pegawai_verifikator";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/"+valinfovalidasilink+"?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid+"&reqValidasi=1"+"&reqInfoValidasi="+valinfovalidasi;
           window.location.href = url;
        }
