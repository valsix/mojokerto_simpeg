...
$arrdata= array(
    array("label"=>"Tahun", "field"=> "TANGGAL_MULAI", "display"=>"",  "width"=>"")
    , array("label"=>"Jenis Cuti", "field"=> "NMCUTI", "display"=>"",  "width"=>"")
    , array("label"=>"No Surat", "field"=> "NO_SURAT", "display"=>"",  "width"=>"")
    , array("label"=>"Tgl. Surat", "field"=> "TANGGAL_SURAT", "display"=>"",  "width"=>"")
    // , array("label"=>"Tgl. Permohonan", "field"=> "TANGGAL_PERMOHONAN", "display"=>"",  "width"=>"")
    , array("label"=>"Lama", "field"=> "CUTI_KETERANGAN", "display"=>"",  "width"=>"")
    , array("label"=>"Tgl. Mulai", "field"=> "TANGGAL_MULAI", "display"=>"",  "width"=>"")
    , array("label"=>"Tgl. Selesai", "field"=> "TANGGAL_SELESAI", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "CUTI_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonpegawaicuti";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_cuti_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsonpegawaicutidelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/pegawai_cuti";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/pegawai_cuti_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
