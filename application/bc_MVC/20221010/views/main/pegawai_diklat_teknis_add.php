...
$set = new InfoData();
$set->selectbyparamsdiklatteknisdata(array('A.RIWAYAT_DIKLAT_TEKNIS_ID'=>$reqRowId));
// echo $set->query;exit;
$set->firstRow();
$reqRowId= $set->getField('RIWAYAT_DIKLAT_TEKNIS_ID');
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-data/info_data_json/diklatteknisadd";
	...
	function btndeletefile(fileid,reqPegawaiId,reqMode) {
		if(fileid !== "")
        {
            urlAjax= "json-data/personal_json/jsondiklatteknisdeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqMode="+reqMode;
            swal.fire({
