...
$arrdata= array(
   array("label"=>"ID_ROW", "field"=> "ID_ROW", "display"=>"1",  "width"=>"")
    , array("label"=>"Pilih", "field"=> "CHECK", "display"=>"",  "width"=>"")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Kenaikan Gaji Berkala Pegawai</h3>
                </div>
            ...
            <div class="card-body">
                ...
                <input type="hidden" id="reqCetakCheck" name="reqCetakCheck" />
            </div>
        </div>
...
jQuery(document).ready(function() {
    ...
    var jsonurl= "json-admin/kenaikan_gaji_berkala_pegawai_json/json_pegawai?reqMode=proses&reqType=A&reqId=<?=$reqId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$tempTahunAktif?>&reqKgb=pegawai";
    ...
    $("#reqSatuanKerja").change(function() {
       ...
       jsonurl= "json-admin/kenaikan_gaji_berkala_pegawai_json/json_pegawai?reqMode=proses&reqType=A&reqId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun=" + reqTahun+"&reqStatusAdministrasi=" + reqStatusAdministrasi+"&setInfoTampil="+setInfoTampil+"&reqKgb=pegawai";
    ...
    $("#btnTampilkanSemuaData").on('click', function () {
       ...
       jsonurl= "json-admin/kenaikan_gaji_berkala_pegawai_json/json_pegawai?reqId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun=" + reqTahun+"&reqStatusAdministrasi=" + reqStatusAdministrasi+"&setInfoTampil="+setInfoTampil+"&reqKgb=pegawai";
    ...
    $("#btncetakblankokgb").click(function() {
        ...
        opUrl= 'admin/loadUrl/admin/kenaikan_gaji_berkala_cetak_sk_blanko?reqId='+reqSatuanKerjaId+'&reqKeterangan<?=$reqKeterangan?>';
    ...
    $("#btnCetaUsulan").click(function() {
        ...
        opUrl= 'admin/loadUrl/admin/kenaikan_gaji_berkala_cetak_usulan?reqId='+reqSatuanKerjaId+'&reqBulan='+reqBulan+'&reqTahun=' + reqTahun+'&reqStatusAdministrasi=' + reqStatusAdministrasi+"&setInfoTampil="+setInfoTampil+"&reqKgb=pegawai";
        newWindow = window.open(opUrl, 'Cetak');
        newWindow.focus();
    });
    ...
    $('#btnProses').click(function() {
        ...
        $("#setInfoTampil").val("1");
        setInfoTampil= $("#setInfoTampil").val();
        jsonproses= 'json-admin/kenaikan_gaji_berkala_pegawai_json/proses_kgb?reqMode=proses_usulan&reqId='+reqSatuanKerjaId+'&reqRowId='+valinfoid+'&reqBulan='+$("#reqBulan").val()+'&reqTahun=' + $("#reqTahun").val()+'&reqStatusAdministrasi=' + reqStatusAdministrasi+'&setInfoTampil=' + setInfoTampil;
        ...
        var jsonurl= "json-admin/kenaikan_gaji_berkala_pegawai_json/json_pegawai?reqMode=proses&reqType=A&reqId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqStatusAdministrasi="+reqStatusAdministrasi+"&setInfoTampil=" + setInfoTampil+"&reqKgb=pegawai";
    ...
    $('#btnSelesai').on('click', function () {
        ...
        else
        {
            ...
            jsonproses= 'json-admin/kenaikan_gaji_berkala_pegawai_json/proses_kgb?reqMode=proses_selesai&reqId='+reqSatuanKerjaId+'&reqRowId='+valinfoid+'&reqBulan='+$("#reqBulan").val()+'&reqTahun=' + $("#reqTahun").val()+'&reqStatusAdministrasi=' + reqStatusAdministrasi+'&setInfoTampil=' + setInfoTampil;
    ...
    $('#btnTidakKgb').on('click', function () {
        ...
        else
        {
            ...
            jsonproses= 'json-admin/kenaikan_gaji_berkala_pegawai_json/proses_kgb?reqMode='+reqMode+'&reqId='+reqSatuanKerjaId+'&reqRowId='+valinfoid+'&reqBulan='+reqBulan+'&reqTahun=' +reqTahun+'&reqStatusAdministrasi='+reqStatusAdministrasi+'&setInfoTampil=' + setInfoTampil;
    ...
    $('#btnCetakKgbLengkap').on('click', function () {
         var reqValidasi= $("#reqCetakCheck").val();
         // console.log(reqValidasi);
         var reqValidasiStatus="";
         if(reqValidasi !=="")
         {
            reqValidasiStatus=1;
         }
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    var pesan ="Apakah anda yakin untuk cetak semua data yang terpilih?";
                }
                ...
                opUrl= 'admin/loadUrl/admin/kenaikan_gaji_berkala_cetak_sk.php?reqId='+valinfoid+'&reqPeriode='+reqPeriode+"&reqKgb=pegawai";
                newWindow = window.open(opUrl, 'Cetak');
                newWindow.focus();
    ...
    $('#btnValidasiPegawai').on('click', function () {
        ...
        else
        {
            ...
            if(anSelectedStatusKgb == 3)
            {
                ...
                var   url    = 'admin/index/kenaikan_gaji_berkala_add_data.php?reqPegawaiId='+reqPecah[0]+'&reqBulan='+reqPecah[1]+"&reqTahun="+reqPecah[2]+"&reqSatkerId="+anSelectedSatkerId+"&reqGaji="+reqPecah[1]+"&reqKgb=pegawai";
...
function setKlikCheck()
{
        ...
        $("#reqCetakCheck").val(reqpilihcheckval);
