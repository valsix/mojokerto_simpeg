        ...
        <div class="d-flex flex-column flex-root">
            <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat">
                    ...
                    <div class="col-md-5 area-kiri-login">
                        <div class="inner">
                            ...
                            <div class="login-signin">
                                <form class="form" id="kt_login_signin_form" action="adminlogin/action" method="post">
                                    <div class="form-group mb-5">
                                        <input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Username" name="reqUser" autocomplete="off" value="<?=$username?>" />
                                    </div>
                                    <div class="form-group mb-5">
                                ...
                                <footer class="container">
                                    <p id="footer-text"><strong>Copyright &copy; 2022 <br><a href="http://bkpsdm.lamongankab.go.id/">Kementrian Dalam Negeri Republik Indonesia</a></strong></p>
                                </footer>
                            </div>
                        </div>
                    </div>
