...
class pegawai_penghargaan_json extends CI_Controller {
	...
	function json()
	{
		$this->load->model("base-data/PegawaiPenghargaan");

		$set= new PegawaiPenghargaan();
		...
		while ($set->nextRow()) 
		{
			...
			foreach($columnsDefault as $valkey => $valitem) 
			{
				...
				{
					$row[$valkey]= '<a class="btn btn-light-primary font-weight-bolder dropdown-toggle" href="'.$set->getField('file').'" target="_blank">Download</a>';
				}
				else
				{
