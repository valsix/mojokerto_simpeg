...
class sertifikat_pendidik_json extends CI_Controller {
	...
	function add()
	{
		...
		$set->setField('LEMBAGA', $reqLembaga);
		$set->setField('SERTIFIKAT', $reqSertifikat);
		$set->setField('TANGGAL', dateToDBCheck($reqTanggal));

		$set->setField('SERTIFIKAT_PENDIDIK_ID', $reqRowId);
