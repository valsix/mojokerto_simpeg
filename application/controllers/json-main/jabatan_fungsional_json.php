...
class jabatan_fungsional_json extends CI_Controller {
	...
	function add()
	{
		...
		$reqKeteranganJabatan 			= $this->input->post("reqKeteranganJabatan");
	
		$set->setField("JABATAN_FUNGSIONAL_ID", $reqId);

		$set->setField('NAMA', $reqNamaJabatan);
        $set->setField('KETERANGAN', $reqKeteranganJabatan);
