...
class riwayat_tugas_tambahan_json extends CI_Controller {
	...
	function add()
	{
		...
		$reqTglBerakhir= $this->input->post("reqTglBerakhir");
		...
		$set->setField("TANGGAL_BERAKHIR", dateToDBCheck($reqTglBerakhir));
