<? 
  ...
  class PendidikanRiwayat extends Entity{ 
    ...
    function insert()
	{
		...
		$str = "INSERT INTO validasi.PENDIDIKAN_RIWAYAT (
				   PENDIDIKAN_RIWAYAT_ID, PEGAWAI_ID, PENDIDIKAN_ID, 
				   NAMA, JURUSAN, TEMPAT, 
				   KEPALA, NO_STTB, TANGGAL_STTB, LAST_CREATE_USER, LAST_CREATE_DATE, LAST_CREATE_SATKER, TEMP_VALIDASI_ID,JURUSAN_PENDIDIKAN_ID)
				VALUES (
