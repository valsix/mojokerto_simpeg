<? 
  ...
  class Kontrak extends Entity{ 
    ...
    function insert()
	{
		$this->setField("RIWAYAT_KONTRAK_ID", $this->getNextId("RIWAYAT_KONTRAK_ID","RIWAYAT_KONTRAK")); 
		
		$str = "INSERT INTO RIWAYAT_KONTRAK (
		...
		$this->query = $str;
		$this->id = $this->getField("RIWAYAT_KONTRAK_ID");	
		// echo $str;exit;
    ...
    function update()
	{
		$str = "
				...
				WHERE RIWAYAT_KONTRAK_ID= ".$this->getField("RIWAYAT_KONTRAK_ID")."
				"; 
				$this->query = $str;
				// echo $str;exit;
		return $this->execQuery($str);
    ...
    function insertupload()
	{
		...
		$str = "INSERT INTO RIWAYAT_KONTRAK_FILE(
	            RIWAYAT_KONTRAK_FILE_ID, RIWAYAT_KONTRAK_ID, PEGAWAI_ID, 
    ...
    function delete()
	{
        $str = "DELETE FROM RIWAYAT_KONTRAK
                WHERE 
                  RIWAYAT_KONTRAK_ID= '".$this->getField("RIWAYAT_KONTRAK_ID")."'"; 
	...
	{
		$str = "
		SELECT A.RIWAYAT_KONTRAK_ID, A.PEGAWAI_ID,A.NO_SK,
		...
		, K.LINK_FILE
		, K.RIWAYAT_KONTRAK_FILE_ID,K.LINK_SERVER

		FROM RIWAYAT_KONTRAK A
		LEFT JOIN GOLONGAN_PPPK B ON B.GOLONGAN_PPPK_ID = A.GOLONGAN_PPPK_ID
		LEFT JOIN RIWAYAT_KONTRAK_FILE K ON K.RIWAYAT_KONTRAK_ID = A.RIWAYAT_KONTRAK_ID
		WHERE 1 = 1
		"; 
	...
	{
		$str = "
		SELECT A.RIWAYAT_KONTRAK_FILE_ID, A.RIWAYAT_KONTRAK_ID, A.PEGAWAI_ID, 
		A.NAMA_FILE, A.LINK_FILE, A.TIPE_FILE,A.LINK_SERVER
		FROM RIWAYAT_KONTRAK_FILE A
		INNER JOIN RIWAYAT_KONTRAK B ON A.RIWAYAT_KONTRAK_ID = B.RIWAYAT_KONTRAK_ID
		WHERE 1=1
		"; 
