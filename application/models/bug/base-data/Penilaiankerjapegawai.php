<? 
  ...
  class PenilaianKerjaPegawai extends Entity{ 
	...
	function insert()
	{
		...
		$this->setField("PENILAIAN_KERJA_PEGAWAI_ID", $this->getNextId("PENILAIAN_KERJA_PEGAWAI_ID","PENILAIAN_KERJA_PEGAWAI")); 

		$str = "INSERT INTO PENILAIAN_KERJA_PEGAWAI (
				...
				NILAI5, NILAI6,  SASARAN_KERJA, SASARAN_KERJA_HASIL, PERILAKU_HASIL, NILAI_PERILAKU, NILAI_HASIL,STATUS,STATUS_ATASAN,TMT_GOLONGAN, NAMA_ATASAN_PENILAI,JABATAN_ATASAN_PENILAI,UNOR_ATASAN_PENILAI,GOLONGAN_ATASAN_PENILAI,TMT_GOLONGAN_ATASAN,PEGAWAI_ID, LAST_CREATE_USER, LAST_CREATE_DATE, LAST_CREATE_SATKER) 
				VALUES (
				...
				//echo $str;
		$this->id = $this->getField("PENILAIAN_KERJA_PEGAWAI_ID");
		$this->query = $str;
		// echo $str;exit;
	...
	{
		$this->setField("PENILAIAN_KERJA_PEGAWAI_FILE_ID", $this->getNextId("PENILAIAN_KERJA_PEGAWAI_FILE_ID","PENILAIAN_KERJA_PEGAWAI_FILE")); 
		
		$str = "INSERT INTO PENILAIAN_KERJA_PEGAWAI_FILE(
	            PENILAIAN_KERJA_PEGAWAI_FILE_ID, PENILAIAN_KERJA_PEGAWAI_ID, PEGAWAI_ID, 
	            NAMA_FILE, LINK_FILE, TIPE_FILE, LAST_CREATE_USER, LAST_CREATE_DATE, LAST_CREATE_SATKER)
				VALUES (
				  ".$this->getField("PENILAIAN_KERJA_PEGAWAI_FILE_ID").",
				  ".$this->getField("PENILAIAN_KERJA_PEGAWAI_ID").",
				  '".$this->getField("PEGAWAI_ID")."',
 	...
 	function update()
	{
		/*Auto-generate primary key(s) by next max value (integer) */
		$str = "
				UPDATE PENILAIAN_KERJA_PEGAWAI
				SET 
				...
				WHERE  PENILAIAN_KERJA_PEGAWAI_ID= ".$this->getField("PENILAIAN_KERJA_PEGAWAI_ID")."
				"; 
				$this->query = $str;
				// echo $str;exit;
		return $this->execQuery($str);
 	...
 	{
 		$str = "
 		UPDATE PENILAIAN_KERJA_PEGAWAI_FILE
 		SET    
 		...
 		LAST_UPDATE_DATE	= ".$this->getField("LAST_UPDATE_DATE").",
 		LAST_UPDATE_SATKER	= '".$this->getField("LAST_UPDATE_SATKER")."'
 		WHERE PENILAIAN_KERJA_PEGAWAI_FILE_ID= ".$this->getField("PENILAIAN_KERJA_PEGAWAI_FILE_ID")."
 		"; 
 		$this->query = $str;
				// echo $str;exit;
 		return $this->execQuery($str);
	...
	function delete()
	{
	 $str = "DELETE FROM PENILAIAN_KERJA_PEGAWAI
			  WHERE 
			 PENILAIAN_KERJA_PEGAWAI_ID= '".$this->getField("PENILAIAN_KERJA_PEGAWAI_ID")."'";  
	...
	function deletefile()
	{
        $str = "DELETE FROM PENILAIAN_KERJA_PEGAWAI_FILE
                  WHERE 
                  PENILAIAN_KERJA_PEGAWAI_FILE_ID= ".$this->getField("PENILAIAN_KERJA_PEGAWAI_FILE_ID")."
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder="")
	{
		...
		SELECT A.PENILAIAN_KERJA_PEGAWAI_ID,
				...
				, G.LINK_FILE
				, G.PENILAIAN_KERJA_PEGAWAI_FILE_ID
				...
				LEFT JOIN PENILAIAN_KERJA_PEGAWAI_FILE G ON G.PENILAIAN_KERJA_PEGAWAI_ID = A.PENILAIAN_KERJA_PEGAWAI_ID
				WHERE 1=1
		"; 
    ...
    function selectByParamsUpload($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder=" ORDER BY PENILAIAN_KERJA_PEGAWAI_FILE_ID")
	{
		$str = "
		SELECT A.PENILAIAN_KERJA_PEGAWAI_FILE_ID,A.PEGAWAI_ID, 
		A.NAMA_FILE, A.LINK_FILE, A.TIPE_FILE
		FROM PENILAIAN_KERJA_PEGAWAI_FILE A
		INNER JOIN PENILAIAN_KERJA_PEGAWAI B ON A.PENILAIAN_KERJA_PEGAWAI_ID = B.PENILAIAN_KERJA_PEGAWAI_ID
		WHERE 1=1
		"; 
