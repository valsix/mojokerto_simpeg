<? 
  ...
  class JabatanRiwayat extends Entity{ 
    ...
    function insert()
	{
		...
		$str = "INSERT INTO validasi.JABATAN_RIWAYAT (
				   ...
				   TMT_JABATAN_FUNGSIONAL, TMT_TUGAS_TAMBAHAN, TGL_SK_PERPANJANGAN_BUP, TMT_BATAS_USIA_PENSIUN, LAST_CREATE_USER, LAST_CREATE_DATE, LAST_CREATE_SATKER, TEMP_VALIDASI_ID)
				VALUES (
