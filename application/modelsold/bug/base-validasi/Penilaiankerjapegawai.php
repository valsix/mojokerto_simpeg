  ...
  class PenilaianKerjaPegawai extends Entity{ 
 	...
 	function insertupload()
	{
		...
		$str = "INSERT INTO PENILAIAN_KERJA_PEGAWAI_FILE(
	            PENILAIAN_KERJA_PEGAWAI_FILE_ID, PENILAIAN_KERJA_PEGAWAI_ID,  PEGAWAI_ID, TEMP_VALIDASI_ID, 
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder="")
	{
		$str = "
			...
			SELECT A.PENILAIAN_KERJA_PEGAWAI_ID,
				...
				,COALESCE(PJ.PENILAIAN_KERJA_PEGAWAI_FILE_ID,PA.PENILAIAN_KERJA_PEGAWAI_FILE_ID)PENILAIAN_KERJA_PEGAWAI_FILE_ID,COALESCE(PJ.LINK_FILE,PA.LINK_FILE)LINK_FILE
				...
				LEFT JOIN PENILAIAN_KERJA_PEGAWAI_FILE PJ ON PJ.TEMP_VALIDASI_ID = A.TEMP_VALIDASI_ID
				LEFT JOIN PENILAIAN_KERJA_PEGAWAI_FILE PA ON PA.PENILAIAN_KERJA_PEGAWAI_ID = A.PENILAIAN_KERJA_PEGAWAI_ID
	...
	{
		$str = "
		SELECT A.PENILAIAN_KERJA_PEGAWAI_FILE_ID, A.PENILAIAN_KERJA_PEGAWAI_ID,  A.PEGAWAI_ID, A.TEMP_VALIDASI_ID, 
		A.NAMA_FILE, A.LINK_FILE, A.TIPE_FILE
		FROM PENILAIAN_KERJA_PEGAWAI_FILE A
		LEFT JOIN validasi.PENILAIAN_KERJA_PEGAWAI B ON A.TEMP_VALIDASI_ID = B.TEMP_VALIDASI_ID
		WHERE 1=1
		"; 
