  ...
  class GajiRiwayat extends Entity{ 
     ...
     function insertupload()
	{
		...
		$str = "INSERT INTO GAJI_RIWAYAT_FILE(
	            GAJI_RIWAYAT_FILE_ID, GAJI_RIWAYAT_ID, PEGAWAI_ID, 
	...
	{
		$str = "
		SELECT GAJI_RIWAYAT_ID, PEGAWAI_ID, TEMP_VALIDASI_HAPUS_ID, 
	...
	{
		$str = "
		SELECT A.GAJI_RIWAYAT_FILE_ID,A.PEGAWAI_ID, 
		A.NAMA_FILE, A.LINK_FILE, A.TIPE_FILE
		FROM GAJI_RIWAYAT_FILE A
		INNER JOIN GAJI_RIWAYAT B ON A.GAJI_RIWAYAT_ID = B.GAJI_RIWAYAT_ID
		WHERE 1=1
		"; 
