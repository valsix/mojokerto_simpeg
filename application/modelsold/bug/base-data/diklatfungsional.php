<? 
  ...
  class DiklatFungsional extends Entity{ 
    ...
    function insert()
	{
		...
		$str = "INSERT INTO validasi.DIKLAT_FUNGSIONAL (
				   DIKLAT_FUNGSIONAL_ID, NAMA, PEGAWAI_ID, TEMPAT, 
    ...
    function delete()
	{
        $str = "DELETE FROM validasi.DIKLAT_FUNGSIONAL
                WHERE 
	...
	{
		$str = "
		SELECT DIKLAT_FUNGSIONAL_ID, PEGAWAI_ID, TEMP_VALIDASI_HAPUS_ID, TEMPAT, 
		   PENYELENGGARA, ANGKATAN, TAHUN, 
		   NO_STTPP, TANGGAL_MULAI, TANGGAL_SELESAI, 
		   TANGGAL_STTPP, JUMLAH_JAM, NAMA
		   ,TEMP_VALIDASI_ID, VALIDASI, VALIDATOR, PERUBAHAN_DATA, TIPE_PERUBAHAN_DATA, TANGGAL_VALIDASI
		FROM validasi.validasi_pegawai_diklat_fungsional
		WHERE 1=1
		"; 
