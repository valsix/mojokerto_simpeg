...
$reqInfoValidasi= $this->input->get('reqInfoValidasi');
// echo $reqValidasi;exit;

$buttonsimpan= "1";
if($reqInfoValidasi == 1 )
{
  $buttonsimpan= "";
}
...
if($reqMode == 'edit' || $reqMode == 'cancel' || $reqMode == 'view')
{
	...
	$reqValidasiStatus= $set->getField('VALIDASI');
            ...
            <form class="form" id="ktloginform" method="POST" enctype="multipart/form-data">
	        	<div class="card-body">
	        		...
	        		{ 
	        			?>
		        		<div class="form-group row">
		        			<label class="col-form-label text-right col-lg-2 col-sm-12">Status Klarifikasi
		        			</label>
		        			<div class="col-lg-8 col-sm-12">
		        				<select <?=$disabled?> class="form-control select2" name="reqStatusValidasi" id="ktStatusValidasi">
	        	...
	        	<div class="card-footer">
	        		<div class="row">
	        			<div class="col-lg-9">
	        				...
	        				<input type="hidden" name="reqValidasi" value="<?=$reqValidasi?>">
	        				<?
	        				if ($buttonsimpan == "1")
	        				{ 
	        				?>
	        				...
	        				{ 
	        				?>
	        					<button onclick="kembalivalidasi()" type="button" class="btn btn-warning font-weight-bold mr-2">Kembali</button>
	        				<?
	        				}
	        				else
	        				{
...
<script type="text/javascript">
	...
	function kembalivalidasi() {
		window.location.href='app/index/pegawai_verifikator'
	}
	...
	jQuery(document).ready(function() {
		...
		if(reqValidasi == 1)
		{
			var formSubmitUrl = "json-validasi/personal_json/jsonpegawaibahasavalidasi"
		}
		else
		{
			var formSubmitUrl = "json-validasi/personal_json/jsonpegawaibahasaadd"
