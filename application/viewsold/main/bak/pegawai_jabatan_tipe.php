...
<div style="height:0px;overflow:hidden">
    <form id="ktloginform" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" id="reqJenisJabatanId" name="reqJenisJabatanId" />
...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonpegawaijabatantipe";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_jabatan_tipe_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsonpegawaijabatantipedelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/pegawai_jabatan_tipe_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
function btnUpload(reqDetilId,reqPegawaiId,reqJenisJabatanId,reqRowId)
{
    $("#reqLinkFile").click();
    $('#reqDetilId').val(reqDetilId);
    $('#reqPegawaiId').val(reqPegawaiId);
    $('#reqJenisJabatanId').val(reqJenisJabatanId);
...
jQuery(document).ready(function(){
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           $.ajax({
            url: 'json-validasi/personal_json/jsonpegawaijabatanupload', 
            dataType: 'json', 
            cache: false,
            contentType: false,
            processData: false,
