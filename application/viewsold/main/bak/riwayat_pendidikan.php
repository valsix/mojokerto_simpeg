...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonriwayatpendidikan";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/riwayat_pendidikan_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsonriwayatpendidikandelete?&reqDetilId="+valinfoid;
            swal.fire({
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/riwayat_pendidikan_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
jQuery(document).ready(function(){
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           $.ajax({
            url: 'json-validasi/personal_json/jsonriwayatpendidikanupload', 
            dataType: 'json', 
            cache: false,
            contentType: false,
            processData: false,
