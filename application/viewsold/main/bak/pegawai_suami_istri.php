...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonpegawaisuamiistri";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_suami_istri_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsonpegawaisuamiistridelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/pegawai_suami_istri_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
function btnUploadKK(reqDetilId,reqPegawaiId,reqRowId)
{
    $("#reqLinkFileKK").click();
...
function btnUploadAkta(reqDetilId,reqPegawaiId,reqRowId)
{
...
function btnUploadKtp(reqDetilId,reqPegawaiId,reqRowId)
{
...
function btnDeleteFile (fileid,reqPegawaiId,reqDetilId,reqRowId,reqMode) {
    if(fileid !== "")
    {
        urlAjax= "json-validasi/personal_json/jsonpegawaisuamiistrideletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqDetilId="+reqDetilId+"&reqRowId="+reqRowId+"&reqMode="+reqMode;
        swal.fire({
