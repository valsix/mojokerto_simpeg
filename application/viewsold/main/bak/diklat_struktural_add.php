...
if($reqMode == 'edit' || $reqMode == 'cancel' || $reqMode == 'view')
{
	if($reqDetilId == "")
	{
		$set->selectByParams(array('A.DIKLAT_STRUKTURAL_ID'=>$reqRowId));
	}
	else
	{
	        	...
	        	<div class="card-body">
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-8 col-sm-12">
	        				<select class="form-control select2" id="ktdiklat" name="reqDiklat" style="width:30%; ">
	        					<option value=""></option>
	        					<?
...
<script type="text/javascript">
	...
	function kembali() {
		window.location.href='app/index/diklat_struktural'
	}
	$('#ktdiklat').select2({
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-validasi/personal_json/jsondiklatstrukturaladd";
