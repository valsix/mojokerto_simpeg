...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "RIWAYAT_DIKLAT_FUNGSIONAL_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/info_data_json/jsondiklatfungsional";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/info_data_json/jsondiklatfungsionaldelete?&reqDetilId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/pegawai_diklat_fungsional_add?formulaid=<?=$formulaid?>&reqRowId="+vpilihid;
    ...
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           var formSubmitButton = KTUtil.getById('ktloginformsubmitbutton');
               ...
               $.ajax({
                url: 'json-data/info_data_json/jsondiklatfungsionalupload', 
                dataType: 'json', 
                cache: false,
                contentType: false,
                processData: false,
...
function btnDeleteFile (fileid,reqPegawaiId,reqRowId,reqMode) {
    if(fileid !== "")
    {
        urlAjax= "json-data/info_data_json/jsondiklatfungsionaldeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqRowId="+reqRowId+"&reqMode="+reqMode;
        swal.fire({
