...
$arrdata= array(
    ...
    , array("label"=>"Jangka Waktu Penilaian", "field"=> "JANGKA_WAKTU", "display"=>"",  "width"=>"")
    , array("label"=>"Sasaran Kerja", "field"=> "SASARAN_KERJA", "display"=>"",  "width"=>"")
    , array("label"=>"Perilaku Kerja", "field"=> "RATA_RATA", "display"=>"",  "width"=>"")
    , array("label"=>"Nilai", "field"=> "NILAI_HASIL", "display"=>"",  "width"=>"")
    , array("label"=>"Kategori", "field"=> "NILAI_HASIL_NAMA", "display"=>"",  "width"=>"")
    , array("label"=>"Rekomendasi", "field"=> "REKOMENDASI", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "PENILAIAN_KERJA_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Penilaian Prestasi Kerja</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Penilaian Prestasi Kerja</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpegawaiprestasi";
    ...
    $("#btnAdd").on("click", function () {
       var url = "data/index/pegawai_penilaian_prestasi_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpegawaipenilaianprestasidelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "data/index/pegawai_penilaian_prestasi";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pegawai_penilaian_prestasi_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
