	        	...
	        	<div class="card-footer">
	        		<div class="row">
	        			<div class="col-lg-9">
	        				...
	        				{
	        				?>
	        					<a class="btn btn-success font-weight-bold mr-2" href="admin/loadUrl/admin/viewer?reqForm=penghargaan&reqFileId=<?=$reqFileId?>" target="_blank">Download</a>
...
<script type="text/javascript">
	...
	function kembali() {
		window.location.href='data/index/pegawai_penghargaan'
	}
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-data/personal_json/jsonpegawaipenghargaanadd";
