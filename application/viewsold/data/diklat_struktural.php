...
$arrdata= array(
    array("label"=>"Diklat", "field"=> "NAMADIKLAT", "display"=>"",  "width"=>"")
    , array("label"=>"Tempat", "field"=> "TEMPAT", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"Tanggal Mulai", "field"=> "TANGGAL_MULAI", "display"=>"",  "width"=>"")
    , array("label"=>"Tanggal Selesai", "field"=> "TANGGAL_SELESAI", "display"=>"", "width"=>"")
    , array("label"=>"No. STTPP", "field"=> "NO_STTPP", "display"=>"", "width"=>"")
    , array("label"=>"Tgl. STTPP", "field"=> "TANGGAL_STTPP", "display"=>"", "width"=>"")
     , array("label"=>"Jumlah Jam", "field"=> "JUMLAH_JAM", "display"=>"", "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "DIKLAT_STRUKTURAL_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Diklat Struktural</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Diklat Struktural</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsondiklatstruktural";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/diklat_struktural_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsondiklatstrukturaldelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/diklat_struktural";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/diklat_struktural_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
