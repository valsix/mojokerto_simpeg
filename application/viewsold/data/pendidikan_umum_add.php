...
<script type="text/javascript">
	...
	function kembali() {
		window.location.href='data/index/pendidikan_umum'
	}
	...
	$("#ktjurusan").select2({
        ...
        allowClear: true,
        ajax: {
            url: "json-data/combo_json/autocompletejurusan",
            dataType: 'json',
            delay: 250,
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-data/personal_json/jsonpendidikanumumadd";
