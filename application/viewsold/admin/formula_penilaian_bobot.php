...
while($set->nextRow())
{
	...
	$arrdata["tipe"]= $set->getField("JENIS");
	        			...
	        			<table class="table table-bordered">
	        				...
	        				<tbody>
	        					...
	        					foreach($arrindikatorpenilaian as $key => $item)
	        					{
	        						...
	        						$infodetilJenis= $item["tipe"];
	        						$infosubindikator= $item["jenis"];
	        						...
	        						if($templateJenis!=$infodetilJenis){
	        							?>
			        					<tr>
			        						<th style="background-color:#009f3b;color: white;" colspan="3"><?=$infodetilJenis?></th>
			        					</tr>
			        					<?
	        							$templateJenis=$infodetilJenis;
	        						}
	        					?>
	        					<tr>
	        						...
	        						<td>
	        							...
	        							<input type="hidden" name="infodetilJenis[]" id="infodetilJenis<?=$infosubindikatorkey?>" value="<?=$infosubindikator?>" />
	        						</td>
	        					</tr>
	        					<?
	        						if($jumlahrow > 1)
