...
jQuery(document).ready(function() {
    ...
    $("#btnCetak").on("click", function () {
        ...
        urlExcel= "admin/loadUrl/admin/export_dashboard?reqFormulaPenilaianId=<?=$reqFormulaPenilaianId?>&reqTipePegawaiId=<?=$reqTipePegawaiId?>&reqPangkatId=<?=$reqPangkatId?>&reqEselonId=<?=$reqEselonId?>&reqSatuanKerja=<?=$reqSatuanKerja?>&reqSatuanKerjaEs2=<?=$reqSatuanKerjaEs2?>&reqKuadranId=<?=$reqKuadranId?>";
