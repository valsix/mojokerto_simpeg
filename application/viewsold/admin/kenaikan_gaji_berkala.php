        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Kenaikan Gaji Berkala</h3>
                </div>
...
jQuery(document).ready(function() {
    ...
    var jsonurl= "json-admin/kenaikan_gaji_berkala_json/json_pegawai?reqMode=proses&reqType=A&reqId=<?=$reqId?>&reqBulan=<?=$reqBulan?>&reqTahun=<?=$tempTahunAktif?>&reqKgb=admin";
    ...
    $("#reqSatuanKerja").change(function() {
       ...
       jsonurl= "json-admin/kenaikan_gaji_berkala_json/json_pegawai?reqMode=proses&reqType=A&reqId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun=" + reqTahun+"&reqStatusAdministrasi=" + reqStatusAdministrasi+"&setInfoTampil="+setInfoTampil+"&reqKgb=admin";
    ...
    $("#btnTampilkanSemuaData").on('click', function () {
       ...
       jsonurl= "json-admin/kenaikan_gaji_berkala_json/json_pegawai?reqId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun=" + reqTahun+"&reqStatusAdministrasi=" + reqStatusAdministrasi+"&setInfoTampil="+setInfoTampil+"&reqKgb=admin";
    ...
    $("#btnCetaUsulan").click(function() {
        ...
        opUrl= 'admin/loadUrl/admin/kenaikan_gaji_berkala_cetak_usulan?reqId='+reqSatuanKerjaId+'&reqBulan='+reqBulan+'&reqTahun=' + reqTahun+'&reqStatusAdministrasi=' + reqStatusAdministrasi+"&setInfoTampil="+setInfoTampil;
        newWindow = window.open(opUrl, 'Cetak');
        newWindow.focus();
    });
    ...
    $('#btnProses').click(function() {
        ...
        var jsonurl= "json-admin/kenaikan_gaji_berkala_json/json_pegawai?reqMode=proses&reqType=A&reqId="+reqSatuanKerjaId+"&reqBulan="+reqBulan+"&reqTahun="+reqTahun+"&reqStatusAdministrasi="+reqStatusAdministrasi+"&setInfoTampil=" + setInfoTampil+"&reqKgb=admin";
    ...
    $('#btnCetakKgbLengkap').on('click', function () {
        ...
        else
        {
            ...
            else
            {
                ...
                opUrl= 'admin/loadUrl/admin/kenaikan_gaji_berkala_cetak_sk.php?reqId='+valinfoid+'&reqPeriode='+reqPeriode;
                newWindow = window.open(opUrl, 'Cetak');
                newWindow.focus();
            }       
