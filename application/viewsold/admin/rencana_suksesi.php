...
$arrtabledata= array(
    ...
    ,array("label"=>"Untuk Jabatan", "field"=> "NAMA_JABATAN", "display"=>"",  "width"=>"")
    ,array("label"=>"Jumlah", "field"=> "JUMLAH", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "RENCANA_SUKSESI_ID", "display"=>"1", "width"=>"")
);
...
jQuery(document).ready(function() {
    $("#reqSatuanKerja,#reqStatusPegawai,#reqBulan,#reqTipePegawai").change(function() {
      ...
      jsonurl= "json-data/info_admin_json/jsonrencanasuksesidata?reqTipePegawai="+reqTipePegawai+"&reqStatusPegawai="+reqStatusPegawai+"&reqSatuanKerja="+satuanKerja;
      // datanewtable.DataTable().filter.reqValidasi = 1;
      // datanewtable.DataTable().draw();
      datanewtable.DataTable().ajax.url(jsonurl).load();
    });

    var jsonurl= "json-data/info_admin_json/jsonrencanasuksesidata";
    ...
    $("#btnAdd,#btnUbahData").on("click", function () {
       btnid= $(this).attr('id');
        ...
        varurl= "admin/index/rencana_suksesi_data?reqId="+vpilihid;
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/info_admin_json/rencanasuksesidelete?reqId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "admin/index/rencana_suksesi";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
