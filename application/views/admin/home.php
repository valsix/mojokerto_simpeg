<script type="text/javascript">
    ...
    $(function() {
      $('#reqPangkatId,#reqEselonId,#reqTipePegawaiId,#reqRumpunId').select2();
    });
                        ...
                        <div class="area-filter">
                            <div class="row mb-8">
                                ...
                                <div class="col-md-4" style="margin-top: 10px">
                                    ...
                                    <select name="reqPangkatId" id="reqPangkatId" class="form-control" multiple>
                                        <?
                                ...
                                <div class="col-md-6" style="margin-top: 10px">
                                    ...
                                    <select name="reqTipePegawaiId" id="reqTipePegawaiId" class="form-control"  multiple>
                                        <?
                                ...
                                <div class="col-md-6" style="margin-top: 10px">
                                    <label>Eselon:</label>
                                    <select name="reqEselonId" id="reqEselonId" class="form-control" multiple>
                                        <?
...
jQuery(document).ready(function() {
    $("#reqSatuanKerja,#reqSatuanKerjaEs2,#reqFormulaPenilaianId,#reqTipePegawaiId,#reqPangkatId,#reqEselonId,#reqRumpunId").change(function() {
        ...
        jsonurl= "json-data/info_admin_json/jsonformulapenilaiankuadranpegawai?reqFormulaPenilaianId="+reqFormulaPenilaianId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqEselonId="+reqEselonId+"&reqRumpunId="+reqRumpunId+"&reqSatuanKerja="+reqSatuanKerja+"&reqSatuanKerjaEs2="+reqSatuanKerjaEs2;
        datanewtable.DataTable().ajax.url(jsonurl).load();

        var vgrafik= "potensikompetensi";
        setGrafik("json-data/info_admin_json/formulapenilaiangrafik?reqFormulaPenilaianId="+reqFormulaPenilaianId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqEselonId="+reqEselonId+"&reqRumpunId="+reqRumpunId+"&reqSatuanKerja="+reqSatuanKerja+"&reqSatuanKerjaEs2="+reqSatuanKerjaEs2+"&m="+vgrafik);
        setModal("kontenidtable", "json-data/info_admin_json/formulapenilaiantable?reqFormulaPenilaianId="+reqFormulaPenilaianId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqEselonId="+reqEselonId+"&reqRumpunId="+reqRumpunId+"&reqSatuanKerja="+reqSatuanKerja+"&reqSatuanKerjaEs2="+reqSatuanKerjaEs2+"&m="+vgrafik);
    });
    ...
    $("#btnAdd,#btnUbahData").on("click", function () {
        ...
        $.ajax({
            url: "admin/setpegawai?reqId="+valinfoid+"&reqAdminId=1",
            processData: false,
            contentType: false,
            type: 'GET',
            dataType: 'json',
            ...
            complete: function () {
                ...
                pageUrl= "app/index/pegawai_formula_data?formulaid=1&reqPegawaiHard="+valinfoid;
                openAdd(pageUrl);
    ...
    $("#btnCetak").on("click", function () {
        ...
        reqSatuanKerja= $("#reqSatuanKerja").val();
        reqSatuanKerjaEs2= $("#reqSatuanKerjaEs2").val();
        urlExcel= "admin/loadUrl/admin/export_dashboard?reqFormulaPenilaianId="+reqFormulaPenilaianId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqEselonId="+reqEselonId+"&reqRumpunId="+reqRumpunId+"&reqSatuanKerja="+reqSatuanKerja+"&reqSatuanKerjaEs2="+reqSatuanKerjaEs2;
...
function setkuadran(reqKuadranId)
{
    reqFormulaPenilaianId= $("#reqFormulaPenilaianId").val();
    reqTipePegawaiId= $("#reqTipePegawaiId").val();
    reqPangkatId= $("#reqPangkatId").val();
    ...
    vurl= "?reqFormulaPenilaianId="+reqFormulaPenilaianId+"&reqTipePegawaiId="+reqTipePegawaiId+"&reqPangkatId="+reqPangkatId+"&reqEselonId="+reqEselonId+"&reqRumpunId="+reqRumpunId+"&reqSatuanKerja="+reqSatuanKerja+"&reqSatuanKerjaEs2="+reqSatuanKerjaEs2+"&reqKuadranId="+reqKuadranId;
    pageUrl= "admin/index_popup/popup_pegawai"+vurl;
    openAdd(pageUrl);
}
