                    ...
                    <div class="col-md-12">
                        ...
                        <div class="area-filter">
                            <div class="row mb-8">
                                ...
                                <div class="col-md-6">
                                    <a class="btn btn-light-primary" href="#">Jenis Jabatan</a>
                                    <a class="btn btn-light-primary" href="#">Rumpun Jabatan</a>
                                    <a class="btn btn-light-primary" href="#">Pangkat/Golongan</a>
                                    <a class="btn btn-light-primary" href="#">Filter Komponen/Unit Eselon I</a>
                                    <a class="btn btn-light-primary" href="#">Usia</a>
                                    <a class="btn btn-light-primary" href="#">Filter Komponen/Unit Eselon II</a>
                                </div>
                            </div>
                        </div>
