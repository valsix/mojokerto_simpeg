...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpegawaidiklat";
    ...
    $("#btnAdd").on("click", function () {
       var url = "data/index/pegawai_diklat_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpegawaidiklatdelete?&reqDetilId="+valinfoid;
            swal.fire({
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pegawai_diklat_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
    ...
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           var formSubmitButton = KTUtil.getById('ktloginformsubmitbutton');
               ...
               $.ajax({
                url: 'json-data/personal_json/jsonpegawaidiklatupload', 
                dataType: 'json', 
                cache: false,
                contentType: false,
                processData: false,
...
function btnUpload(reqPegawaiId,reqRowId,reqDiklatId)
{
    $("#reqLinkFile").click();
