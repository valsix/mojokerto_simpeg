...
$set   = new SkCpns();
$set->selectByParams(array("A.PEGAWAI_ID" => $reqPegawaiId));
$set->firstRow();
// echo $set->query;exit;
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<div class="input-group date">
		        				<input type="text" class="form-control" id="kttanggalnota" name="reqTanggalNotaBAKN" <?=$disabled?> placeholder="Masukkan Tanggal Nota" value="<?=$reqTanggalNotaBAKN?>" />
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-data/personal_json/jsonpegawaiskcpnsadd";
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "data/index/pegawai_sk_cpns";
			        	});
			        },
