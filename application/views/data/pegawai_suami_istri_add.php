	        	...
	        	<div class="card-body">
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				...
	        				{
	        					?>
	        					<a class="btn btn-primary font-weight-bold mr-2" href="app/loadUrl/admin/viewer?reqForm=akta&reqFileId=<?=$reqFileId?>" target="_blank">Download</a>
	        					<a class="btn btn-danger font-weight-bold mr-2" onclick="btndeletefile('<?=$reqFileId?>','<?=$reqPegawaiId?>','akta')">Hapus File</a>
	        					<?
	        				}
	        				?>
	        			</div>
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				<?if(!file_exists($reqLinkFileKK))
	        				{
	        					...
	        					{
	        						?>
	        						<a class="btn btn-primary font-weight-bold mr-2" href="<?=$file_name_kk?>" target="_blank">Download</a>
	        						<? 
	        					}
	        					?>
	        					<?
	        				...
	        				{
	        					?>
	        					<a class="btn btn-primary font-weight-bold mr-2" href="app/loadUrl/admin/viewer?reqForm=kk&reqFileId=<?=$reqFileId?>" target="_blank">Download</a>
	        					<a class="btn btn-danger font-weight-bold mr-2" onclick="btndeletefile('<?=$reqFileId?>','<?=$reqPegawaiId?>','kk')">Hapus File</a>
	        					<?
	        				}
	        				?>
	        			</div>
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-4 col-sm-12">
	        				...
	        				{
	        					?>
	        					<a class="btn btn-primary font-weight-bold mr-2" href="app/loadUrl/admin/viewer?reqForm=ktp&reqFileId=<?=$reqFileId?>" target="_blank">Download</a>
	        					<a class="btn btn-danger font-weight-bold mr-2" onclick="btndeletefile('<?=$reqFileId?>','<?=$reqPegawaiId?>','ktp')">Hapus File</a>
	        					<?
	        				}
	        				?>
	        			</div>
...
<script type="text/javascript">
	...
	function kembali() {
		window.location.href='data/index/pegawai_suami_istri'
	}
	$('#ktstatus').select2({
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-data/personal_json/jsonpegawaisuamiistriadd";
	...
	function btndeletefile(fileid,reqPegawaiId,reqMode) {
		if(fileid !== "")
        {
            urlAjax= "json-data/personal_json/jsonpegawaisuamiistrideletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqMode="+reqMode;
            swal.fire({
