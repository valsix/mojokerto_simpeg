...
$arrdata= array(
    array("label"=>"Nama Diklat", "field"=> "NAMA", "display"=>"",  "width"=>"")
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Diklat Fungsional</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Diklat Fungsional</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsondiklatfungsional";
    ...
    $('#'+infotableid+' tbody').on( 'click', 'tr', function () {
     ...
     $("#btnAdd").on("click", function () {
       var url = "app/index/diklat_fungsional_add?reqPegawaiId=<?=$reqPegawaiId?>";
     ...
     $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsondiklatfungsionaldelete?&reqDetilId="+valinfovalidasiid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/diklat_fungsional";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/diklat_fungsional_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
