...
jQuery(document).ready(function() {
    var jsonurl= "json-data/personal_json/jsonpegawaipenghargaan";
    ...
    $('#'+infotableid+' tbody').on( 'click', 'tr', function () {
     ...
     $("#btnAdd").on("click", function () {
       var url = "data/index/pegawai_penghargaan_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/personal_json/jsonpegawaipenghargaandelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "data/index/pegawai_penghargaan";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "data/index/pegawai_penghargaan_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
function btnUpload(reqPegawaiId,reqTahun,reqRowId)
{
    $("#reqLinkFile").click();
    ...
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           var formSubmitButton = KTUtil.getById('ktloginformsubmitbutton');
               ...
               $.ajax({
                url: 'json-data/personal_json/jsonpegawaipenghargaanupload', 
                dataType: 'json', 
                cache: false,
                contentType: false,
                processData: false,
...
function btnDeleteFile (fileid,reqPegawaiId,reqRowId) {
    if(fileid !== "")
    {
        urlAjax= "json-data/personal_json/jsonpegawaipenghargaandeletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqRowId="+reqRowId;
        swal.fire({
