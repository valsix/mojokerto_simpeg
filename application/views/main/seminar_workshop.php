...
$arrtabledata= array(
    array("label"=>"Nama Pelatihan", "field"=> "NAMA", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"No Piagam", "field"=>"NO_PIAGAM", "getField", "display"=>"",  "width"=>"")
    , array("label"=>"Tgl Piagam", "field"=> "TANGGAL_PIAGAM", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "SEMINAR_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Seminar / Workshop</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Seminar / Workshop</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/seminar_workshop_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/seminar_workshop_json/delete?reqRowId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/seminar_workshop?reqId=<?=$reqId?>";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/seminar_workshop_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
