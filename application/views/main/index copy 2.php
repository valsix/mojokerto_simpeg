                            ...
                            <ul class="menu-nav">
                                <li class="menu-item menu-item-submenu  menu-item-here" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="app/index/pegawai_dashboard" class="menu-link menu-toggle">
                                        <span class="menu-text">Dashboard Pegawai</span>
                                    ...
                                    <nav class="navbar navbar-default">
                                        <div class="container-fluid">
                                            <div class="navbar-header">
                                                <button type="button" class="navbar-toggle collapsed btn btn-warning" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i class="fa fa-id-card" aria-hidden="true"></i> Menu&nbsp;FIP
                                            ...
                                            <div id="navbar" class="navbar-collapse collapse">
                                                ...
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li class="subheader"><a href="#">FIP 01</a></li>
                                                    ...
                                                    <li class="subheader"><a href="#">FIP 02</a></li>
