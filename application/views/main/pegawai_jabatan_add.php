	        	...
	        	<div class="card-body">
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-10 col-sm-12">
	        				...
	        				<select class="form-control" id="reqJabatanId" name="reqJabatanId">
	        					<option value=""></option>
							</select>
	        			</div>
	        		</div>
...
<script type="text/javascript">
	...
	// $("#reqJabatanId").select2("val", "");
	// $("#reqJabatanId").val("");

	$('#reqJabatanId').change(function(e) {
		valinfo= $("#reqJabatanId").select2('data');
		// console.log(valinfo);
		valinfoid= valinfo[0].id;
		valinfotext= valinfo[0].text;
		$("#reqNamaJabatan").val(valinfotext);
	});
