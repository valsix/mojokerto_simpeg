...
else
{
	...
	// echo $set->query;exit;
	$set->firstRow();
	$reqId= $set->getField('PANGKAT_ID');
	
	$reqNamaPangkat 			= $set->getField('NAMA');
	$reqKodePangkat 			= $set->getField('KODE');
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					<li class="breadcrumb-item text-muted">
						<a class="" href="app/index/master_pangkat"><?=$pgtitle?></a>
					</li>
					<li class="breadcrumb-item text-muted">
	        	...
	        	<div class="card-body">
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-6 col-sm-12">
	        				<input type="text" class="form-control" name="reqNamaPangkat" id="reqNamaPangkat" required value="<?=$reqNamaPangkat?>" />
	        			</div>
	        		</div>
	        		<div class="form-group row">
	        			<label class="col-form-label text-right col-lg-2 col-sm-12">Kode</label>
	        			<div class="col-lg-6 col-sm-12">
	        				<input type="text" class="form-control" name="reqKodePangkat" maxlength="5" id="reqKodePangkat" required value="<?=$reqKodePangkat?>" />
	        			</div>
	        		</div>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-main/pangkat_json/add";
			...
			form,
			{
				fields: {
					...
					reqKodePangkat: {
						validators: {
							notEmpty: {
								message: 'Anda belum mengisi Kode'
							},
						}
					},
				},
					...
					success: function (response) {
                        ...
                        else
                        {
                            Swal.fire({
                                ...
                                document.location.href = "app/index/master_pangkat";
