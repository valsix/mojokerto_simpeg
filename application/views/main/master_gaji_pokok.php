...
$arrtabledata= array(
    ...
    , array("label"=>"Gaji", "field"=> "GAJI", "display"=>"",  "width"=>"")
    , array("label"=>"Pangkat Id", "field"=> "KODE", "display"=>"",  "width"=>"")
   
    , array("label"=>"sorderdefault", "field"=> "SORDERDEFAULT", "display"=>"1", "width"=>"")
    , array("label"=>"fieldid", "field"=> "GAJI_POKOK_ID", "display"=>"1", "width"=>"")
);
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/gaji_pokok_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/gaji_pokok_json/delete?reqId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/master_gaji_pokok_add?reqId="+vpilihid;
