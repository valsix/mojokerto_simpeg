...
$arrdata= array(
    ...
    , array("label"=>"Masa Kerja", "field"=> "MASA_KERJA_TAHUN", "display"=>"",  "width"=>"")
    , array("label"=>"Pejabat Penatap", "field"=> "PEJABAT_PENETAP", "display"=>"", "width"=>"")
    , array("label"=>"Jenis", "field"=> "NMJENISKENAIKAN", "display"=>"", "width"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonpegawairiwayatgaji";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_gaji_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-validasi/personal_json/jsonriwayatgajidelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/pegawai_gaji";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/pegawai_gaji_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfoid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
function btnDeleteFile (fileid,reqPegawaiId,reqDetilId,reqRowId) {
    if(fileid !== "")
    {
        urlAjax= "json-validasi/personal_json/jsonriwayatgajideletefile?reqFileId="+fileid+"&reqPegawaiId="+reqPegawaiId+"&reqDetilId="+reqDetilId+"&reqRowId="+reqRowId;
        swal.fire({
...
jQuery(document).ready(function(){
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           $.ajax({
            url: 'json-validasi/personal_json/jsonriwayatgajiupload', 
            dataType: 'json', 
            cache: false,
            contentType: false,
            processData: false,
