...
jQuery(document).ready(function() {
    var jsonurl= "json-validasi/personal_json/jsonpegawaikontrak";
    ...
    $("#btnAdd").on("click", function () {
       var url = "app/index/pegawai_riwayat_kontrak_add?reqPegawaiId=<?=$reqPegawaiId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        else
        {
           ...
           {
                urlAjax= "json-validasi/personal_json/jsonpegawaikontrakdelete?&reqDetilId="+valinfovalidasiid;
                swal.fire({
    ...
    $("#btnUbahData").on("click", function () {
        ...
        {
           var url = "app/index/pegawai_riwayat_kontrak_add?reqPegawaiId=<?=$reqPegawaiId?>&reqMode=edit&reqDetilId="+valinfovalidasiid+"&reqRowId="+valinfoid;
           window.location.href = url;
        }
...
jQuery(document).ready(function(){
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           $.ajax({
            url: 'json-validasi/personal_json/jsonpegawaikontrakupload', 
            dataType: 'json', 
            cache: false,
            contentType: false,
            processData: false,
