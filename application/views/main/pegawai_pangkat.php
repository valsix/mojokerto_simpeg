...
$arrtabledata= array(
    array("label"=>"Pangkat", "field"=> "PANGKAT_INFO", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"Masa Kerja Tahun", "field"=> "MK_TAHUN", "display"=>"",  "width"=>"")
    , array("label"=>"Masa Kerja Bulan", "field"=> "MK_BULAN", "display"=>"", "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "RIWAYAT_PANGKAT_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/info_data_json/jsonpangkatriwayat";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/pegawai_pangkat_json/delete?&reqId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/pegawai_pangkat?formulaid=<?=$formulaid?>";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/pegawai_pangkat_add?formulaid=<?=$formulaid?>&reqRowId="+vpilihid;
    ...
    jQuery('#ktloginform').submit(function(event){ 
        event.preventDefault();
           ...
           var formSubmitButton = KTUtil.getById('ktloginformsubmitbutton');
               ...
               $.ajax({
                url: 'json-data/info_data_json/jsonpangkatriwayatupload', 
                dataType: 'json', 
                cache: false,
                contentType: false,
                processData: false,
