...
$objPHPexcel= PHPExcel_IOFactory::load('Templates/BiodataLengkap.xlsx');
$styleProses= array(
	'fill' => array(
...
if($allrecord!=0){
	$objWorksheet->removeRow(34);
	$objWorksheet->insertNewRowBefore(34, $allrecord);
}
$urut=1;
$no=34;
...
while($PelatihanKepemimpinan->nextRow()){
	$objWorksheet->setCellValue("a".$no,$urut);
	$objWorksheet->setCellValue("b".$no,$PelatihanKepemimpinan->getField('NAMADIKLAT'))->mergeCells('b'.$no.':d'.$no);
	$objWorksheet->setCellValue("e".$no,$PelatihanKepemimpinan->getField('TEMPAT').'/'.$PelatihanKepemimpinan->getField('PENYELENGGARA'))->mergeCells('e'.$no.':i'.$no);
	$objWorksheet->setCellValue("j".$no,$PelatihanKepemimpinan->getField('ANGKATAN').'/'.$PelatihanKepemimpinan->getField('TANGGAL_MULAI'))->mergeCells('j'.$no.':l'.$no);
	$objWorksheet->setCellValue("m".$no,$PelatihanKepemimpinan->getField('NO_STTPP'))->mergeCells('m'.$no.':p'.$no);
	$objWorksheet->setCellValue("q".$no,$PelatihanKepemimpinan->getField('TANGGAL_STTPP'))->mergeCells('q'.$no.':s'.$no);
	$no++;
	$urut++;
} 
...
while($PelatihanFungsional->nextRow()){
	$objWorksheet->setCellValue("a".$no,$urut);
	$objWorksheet->setCellValue("b".$no,$PelatihanFungsional->getField('NAMA'))->mergeCells('b'.$no.':d'.$no);
	$objWorksheet->setCellValue("e".$no,$PelatihanFungsional->getField('TEMPAT').'/'.$PelatihanFungsional->getField('PENYELENGGARA'))->mergeCells('e'.$no.':i'.$no);
	$objWorksheet->setCellValue("j".$no,$PelatihanFungsional->getField('ANGKATAN').'/'.$PelatihanFungsional->getField('TANGGAL_MULAI'))->mergeCells('j'.$no.':l'.$no);
	$objWorksheet->setCellValue("m".$no,$PelatihanFungsional->getField('NO_STTPP'))->mergeCells('m'.$no.':p'.$no);
	$objWorksheet->setCellValue("q".$no,$PelatihanFungsional->getField('TANGGAL_STTPP'))->mergeCells('q'.$no.':s'.$no);
	$no++;
	$urut++;
} 
...
while($PelatihanTeknis->nextRow()){
	$objWorksheet->setCellValue("a".$no,$urut);
	$objWorksheet->setCellValue("b".$no,$PelatihanTeknis->getField('NAMA'))->mergeCells('b'.$no.':d'.$no);
	$objWorksheet->setCellValue("e".$no,$PelatihanTeknis->getField('TEMPAT').'/'.$PelatihanFungsional->getField('PENYELENGGARA'))->mergeCells('e'.$no.':i'.$no);
	$objWorksheet->setCellValue("j".$no,$PelatihanTeknis->getField('ANGKATAN').'/'.$PelatihanTeknis->getField('TANGGAL_MULAI'))->mergeCells('j'.$no.':l'.$no);
	$objWorksheet->setCellValue("m".$no,$PelatihanTeknis->getField('NO_STTPP'))->mergeCells('m'.$no.':p'.$no);
	$objWorksheet->setCellValue("q".$no,$PelatihanTeknis->getField('TANGGAL_STTPP'))->mergeCells('q'.$no.':s'.$no);
	$no++;
	$urut++;
} 
...
while($SeminarWorkshop->nextRow()){
	$objWorksheet->setCellValue("a".$no,$urut);
	$objWorksheet->setCellValue("b".$no,$SeminarWorkshop->getField('NAMA'))->mergeCells('b'.$no.':d'.$no);
	$objWorksheet->setCellValue("e".$no,$SeminarWorkshop->getField('TEMPAT').'/'.$PelatihanFungsional->getField('PENYELENGGARA'))->mergeCells('e'.$no.':i'.$no);
	$objWorksheet->setCellValue("j".$no,$SeminarWorkshop->getField('TANGGAL_MULAI'))->mergeCells('j'.$no.':l'.$no);
	$objWorksheet->setCellValue("m".$no,$SeminarWorkshop->getField('NO_PIAGAM'))->mergeCells('m'.$no.':p'.$no);
	$objWorksheet->setCellValue("q".$no,$SeminarWorkshop->getField('TANGGAL_PIAGAM'))->mergeCells('q'.$no.':s'.$no);
	$no++;
	$urut++;
} 
...
while($set->nextRow()){
	...
	$objWorksheet->setCellValue("f".$no,$set->getField('TEMPAT').'/'.$set->getField('PENYELENGGARA'))->mergeCells('f'.$no.':i'.$no);
	$objWorksheet->setCellValue("j".$no,$set->getField('TANGGAL_MULAI'))->mergeCells('j'.$no.':m'.$no);
	$objWorksheet->setCellValue("n".$no,$set->getField('NO_PIAGAM'))->mergeCells('n'.$no.':q'.$no);
	$objWorksheet->setCellValue("r".$no,$set->getField('TANGGAL_PIAGAM'))->mergeCells('r'.$no.':t'.$no);
	$no++;
	$urut++;
} 
...
$objWriter->save('Templates/BiodataLengkap-'.$reqId.'.xls');

$down= 'Templates/BiodataLengkap-'.$reqId.'.xls';
