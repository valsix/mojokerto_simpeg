...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "JABATAN_FUNGSIONAL_ID", "display"=>"1", "width"=>"")
);
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/jabatan_fungsional_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/jabatan_fungsional_json/delete?reqId="+valinfoid;
            swal.fire({
