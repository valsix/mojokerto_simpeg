...
$arrtabledatath1= array(
    ...
    , array("label"=>"Gol Ruang", "field"=> "", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"4")
    , array("label"=>"Jenis Kelamin", "field"=> "", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"2")
    , array("label"=>"Status Kawin", "field"=> "", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"4")
);


$arrtabledatath2= array(
     array("label"=>"I", "field"=> "TOT_GOL1", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    ...
    , array("label"=>"P", "field"=> "TOT_P", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"KW", "field"=> "TOT_KW", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"BL", "field"=> "TOT_BL", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"JD", "field"=> "TOT_JD", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"DD", "field"=> "TOT_DD", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/report_json/json_rekap_pensiun?reqPeriode="+ $("#reqPeriode").val()+"&reqTahun="+ $("#reqTahun").val();
    ...
    $("#reqPeriode").change(function() { 
        jsonurl= "json-main/report_json/json_rekap_pensiun?reqSatkerId=<?=$reqId?>&reqPeriode=" + $("#reqPeriode").val()+"&reqTahun=" + $("#reqTahun").val();
    ...
    $("#btnCetak").on("click", function () {
        ...
        varurl= "json-main/cetak_report_json/pensiun?reqPeriode="+reqPeriode+"&reqTahun="+reqTahun;
