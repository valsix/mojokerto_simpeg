...
$diklat_teknis= new PelatihanTeknis();
$diklat_teknis->selectByParams(array('diklat_teknis_ID'=>$reqRowId));
$diklat_teknis->firstRow();
$reqDIKLAT_TEKNIS_ID = $diklat_teknis->getField('DIKLAT_TEKNIS_ID');
$reqDiklat = $diklat_teknis->getField('DIKLAT_ID');
$reqTahun = $diklat_teknis->getField('TAHUN');
$reqNoSTTPP = $diklat_teknis->getField('NO_STTPP');
$reqPenyelenggara 			= $diklat_teknis->getField('PENYELENGGARA');
$reqAngkatan 		= $diklat_teknis->getField('ANGKATAN');
$reqTglMulai 		= dateToPageCheck($diklat_teknis->getField('TANGGAL_MULAI'));
$reqTglSelesai 		= dateToPageCheck($diklat_teknis->getField('TANGGAL_SELESAI'));
$reqTglSTTPP 		= dateToPageCheck($diklat_teknis->getField('TANGGAL_STTPP'));
//$reqPegawaiId		= $diklat_teknis->getField('PEGAWAI_ID');
$reqTempat		= $diklat_teknis->getField('TEMPAT');
$reqJumlahJam		= $diklat_teknis->getField('JUMLAH_JAM');
$reqNamaDiklat = $diklat_teknis->getField('NAMA');
		...
		<div class="d-flex align-items-center flex-wrap mr-1">
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					...
					<li class="breadcrumb-item text-muted">
						<a class="" href="app/index/pelatihan_teknis?reqId=<?=$reqId?>">Pelatihan Teknis</a>
					</li>
					<li class="breadcrumb-item text-muted">
