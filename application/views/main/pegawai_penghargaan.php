...
$arrtabledata= array(
    ...
    ,array("label"=>"File", "field"=> "file", "display"=>"",  "width"=>"")
...
jQuery(document).ready(function() {
    $("#reqSatuanKerja,#reqStatusPegawai,#reqBulan,#reqTipePegawai").change(function() {
      ...
      jsonurl= "json-data/pegawai_penghargaan_json/json?reqTipePegawai="+reqTipePegawai+"&reqPegawaiHard=<?=$reqPegawaiHard?>&reqStatusPegawai="+reqStatusPegawai+"&reqSatuanKerja="+satuanKerja;
      // datanewtable.DataTable().filter.reqValidasi = 1;
      // datanewtable.DataTable().draw();
      datanewtable.DataTable().ajax.url(jsonurl).load();
    });

    var jsonurl= "json-data/pegawai_penghargaan_json/json?reqBulan=<?=$reqBulan?>&reqPegawaiHard=<?=$reqPegawaiHard?>&reqTahun=<?=$reqTahun?>&reqValidasi=<?=$reqValidasi?>&reqSatuanKerja=<?=$reqSatuanKerja?>";
