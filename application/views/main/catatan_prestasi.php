...
$arrtabledata= array(
    ...
    , array("label"=>"Prestasi", "field"=> "NAMA", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "PRESTASI_KERJA_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Catatan Prestasi</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Catatan Prestasi</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/catatan_prestasi_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/catatan_prestasi_json/delete?&reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/catatan_prestasi_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
