...
$arrtabledata= array(
    array("label"=>"Nomor Surat Ijin Belajar/Tugas Belajar", "field"=> "NOMOR_SURAT", "display"=>"",  "width"=>"")
    , array("label"=>"Tanggal Surat ", "field"=> "TANGGAL_SURAT", "display"=>"",  "width"=>"")
    , array("label"=>"Nama Perguruan Tinggi", "field"=> "NAMA_PERGURUAN", "display"=>"",  "width"=>"")
    , array("label"=>"Program Studi", "field"=> "PROGRAM_STUDI", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "IJIN_BELAJAR_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Ijin Belajar</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Ijin Belajar</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/ijin_belajar_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/ijin_belajar_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/ijin_belajar_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
