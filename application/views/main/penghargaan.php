...
jQuery(document).ready(function() {
    var jsonurl= "json-main/penghargaan_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/penghargaan_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/penghargaan_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
