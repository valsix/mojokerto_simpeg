...
$arrtabledata= array(
    ...
    , array("label"=>"Tgl. Berakhir", "field"=> "TANGGAL_BERAKHIR", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "JABATAN_TAMBAHAN_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Riwayat Tugas Tambahan</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Riwayat Tugas Tambahan</h3>
                </div>
