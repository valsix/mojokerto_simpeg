...
jQuery(document).ready(function() {
    var jsonurl= "json-main/hukuman_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/hukuman_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/hukuman_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
