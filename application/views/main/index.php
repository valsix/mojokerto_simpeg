                      ...
                      <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                                ...
                                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="border: 0px solid red; margin-top: 0px !important; margin-bottom: 0px !important;">
                                    ...
                                    <ul class="menu-nav">
                                        ...
                                        <li class="menu-item menu-item-submenu  menu-item-here" aria-haspopup="true" data-menu-toggle="hover" <?if($pg=='laporan_bkpp_rekap_eselon_jabatan'){?>style="background-color: #EE9D01;"<?}?>>
                                            <a href="app/index/laporan_bkpp_rekap_eselon_jabatan" class="menu-link ">
                                                <span class="menu-text">Rekap Eselon & Jabatan</span>
                                            </a>
                                        </li>
                                        <li class="menu-item menu-item-submenu  menu-item-here" aria-haspopup="true" data-menu-toggle="hover" <?if($pg=='laporan_bkpp_rekap_eselon'){?>style="background-color: #EE9D01;"<?}?>>
                                            <a href="app/index/laporan_bkpp_rekap_eselon" class="menu-link ">
                                                <span class="menu-text">Rekap Eselon</span>
                                            </a>
                                        </li>
                                        <li class="menu-item menu-item-submenu  menu-item-here" aria-haspopup="true" data-menu-toggle="hover" <?if($pg=='laporan_bkpp_rekap_kelkawinpendaga'){?>style="background-color: #EE9D01;"<?}?>>
                                            <a href="app/index/laporan_bkpp_rekap_kelkawinpendaga" class="menu-link ">
                                                <span class="menu-text">Rekap KelKawinPendaga</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="menu-item menu-item-submenu  menu-item-here" aria-haspopup="true" data-menu-toggle="hover" <?if($pg=='laporan_skpd_pensiun_all'){?>style="background-color: #EE9D01;"<?}?>>
                                            <a href="app/index/laporan_skpd_pensiun_all" class="menu-link ">
                                                <span class="menu-text">Rekap Pensiun All</span>
                                            </a>
                                        </li>
