...
else
{
	...
	// echo $set->query;exit;
	$set->firstRow();
	$reqId= $set->getField('PEJABAT_PENETAP_ID');
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					<li class="breadcrumb-item text-muted">
						<a class="" href="app/index/master_pejabat_penetap"><?=$pgtitle?></a>
					</li>
					<li class="breadcrumb-item text-muted">
            ...
            <form class="form" id="ktloginform" method="POST" enctype="multipart/form-data" autocomplete="off">
	        	<div class="card-body">
	        		...
	        		<div class="form-group row">
	        			...
	        			<div class="col-lg-6 col-sm-12">
	        				<input type="text" class="form-control" name="reqNIP" id="reqNIP" required value="<?=$reqNIP?>" />
	        			</div>
	        		</div>
	        		<div class="form-group row">
	        			<label class="col-form-label text-right col-lg-2 col-sm-12">Jabatan</label>
	        			<div class="col-lg-6 col-sm-12">
	        				<input type="text" class="form-control" name="reqJabatan" id="reqJabatan" required value="<?=$reqJabatan?>" />
	        			</div>
	        		</div>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-main/pejabat_penetap_json/add";
			...
			form,
			{
				fields: {
					...
					reqNIP: {
						validators: {
							notEmpty: {
								message: 'Anda belum mengisi Nip'
							},
						}
					},
					reqJabatan: {
					...
					success: function (response) {
                        ...
                        else
                        {
                            Swal.fire({
                                ...
                                document.location.href = "app/index/master_pejabat_penetap";
