...
jQuery(document).ready(function() {
    var jsonurl= "json-main/organisasi_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/organisasi_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/organisasi_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
