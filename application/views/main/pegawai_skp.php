...
$arrtabledata= array(
    ...
    ,array("label"=>"Nilai Pengukuran", "field"=> "Nilai_pengukuran", "display"=>"",  "width"=>"")
    ,array("label"=>"Rata Perilaku", "field"=> "rata_perilaku", "display"=>"",  "width"=>"")
    ,array("label"=>"Nilai SKP", "field"=> "nilai_skp", "display"=>"",  "width"=>"")
    ,array("label"=>"Nilai Kinerja", "field"=> "nilai_kinerja", "display"=>"",  "width"=>"")
    ,array("label"=>"Hasil Karya", "field"=> "hasil_karya", "display"=>"",  "width"=>"")
    ,array("label"=>"Perilaku Krrja", "field"=> "perilaku_kerja", "display"=>"",  "width"=>"")
    ,array("label"=>"Kinerja Pegawai", "field"=> "kinerja_pegawai", "display"=>"",  "width"=>"")
    // ,array("label"=>"Penilai", "field"=> "penilai", "display"=>"",  "width"=>"")
    // ,array("label"=>"Atasan Penilai", "field"=> "atasan_penilai", "display"=>"",  "width"=>"")
    ,array("label"=>"File", "field"=> "file_skp", "display"=>"",  "width"=>"")
...
jQuery(document).ready(function() {
    $("#reqSatuanKerja,#reqStatusPegawai,#reqBulan,#reqTipePegawai").change(function() {
      ...
      jsonurl= "json-data/pegawai_skp_json/json?reqTipePegawai="+reqTipePegawai+"&reqStatusPegawai="+reqStatusPegawai+"&reqPegawaiHard=<?=$reqPegawaiHard?>&reqSatuanKerja="+satuanKerja;
      // datanewtable.DataTable().filter.reqValidasi = 1;
      // datanewtable.DataTable().draw();
      datanewtable.DataTable().ajax.url(jsonurl).load();
    });

    var jsonurl= "json-data/pegawai_skp_json/json?reqBulan=<?=$reqBulan?>&reqPegawaiHard=<?=$reqPegawaiHard?>&reqTahun=<?=$reqTahun?>&reqValidasi=<?=$reqValidasi?>&reqSatuanKerja=<?=$reqSatuanKerja?>";
...
$('#btnDelete').on('click', function (e) {
    ...
    {
        urlAjax= "json-data/pegawai_skp_json/delete?&reqDetilId="+valinfoid;
        swal.fire({
