...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "DIKLAT_ID", "display"=>"1", "width"=>"")
);
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/diklat_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/diklat_json/delete?reqId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/master_diklat_add?reqId="+vpilihid;
