        ...
        <div class="card card-custom">
        	<div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Identitas SK CPNS</h3>
                </div>
            </div>
	        		...
	        		<div class="row">
		        		...
		        		<div class="col-md-12">
		        			<div class="form-group row">
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">No. Nota BAKN</label>
			        			<div class="col-lg-9 col-sm-12">
			        				<input type="text" class="form-control" <?=$readonly?> style="background-color: #F3F6F9;" name="reqNama" id="reqNama" placeholder="No. Nota BAKN" value="<?=$reqNama?>" />
			        			</div>
			        		</div>	
			        		<div class="form-group row">
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">Tanggal Nota BAKN</label>
			        		...
			        		<div class="form-group row">
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">Pejabat Penetapan</label>
			        			<div class="col-lg-3 col-sm-12">
			        		...
			        		<div class="form-group row">
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">Nama Pejabat Penetap</label>
			        			<div class="col-lg-9 col-sm-12">
			        				<input type="text" class="form-control" name="reqNama" id="reqNama" placeholder="Nama Pejabat Penetap" value="<?=$reqNama?>" />
			        			</div>
			        		</div>	
			        		<div class="form-group row">
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">NIP Pejabat Penetap</label>
			        			<div class="col-lg-9 col-sm-12">
			        				<input type="text" class="form-control" name="reqNama" id="reqNama" placeholder="NIP Pejabat Penetap" value="<?=$reqNama?>" />
			        			</div>
			        		</div>	
			        		<div class="form-group row">
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">No. Surat Keputusan</label>
			        			<div class="col-lg-9 col-sm-12">
			        				<input type="text" class="form-control" name="reqNama" id="reqNama" placeholder="No. Surat Keputusan" value="<?=$reqNama?>" />
			        			</div>
			        		</div>	
			        		<div class="form-group row">
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">Tanggal Surat Keputusan</label>
			        			<div class="col-lg-3 col-sm-12">
			        				<div class="input-group date">
				        				<input type="text" autocomplete="off" class="form-control" id="kttanggallahir" name="reqTanggalLahir" placeholder="Select date" value="<?=$reqTanggalLahir?>" />
				        				<div class="input-group-append">
			        			...
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">Terhitung Mulai Tanggal</label>
			        			<div class="col-lg-3 col-sm-12">
			        				<div class="input-group date">
				        				<input type="text" autocomplete="off" class="form-control" id="kttanggallahir" name="reqTanggalLahir" placeholder="Select date" value="<?=$reqTanggalLahir?>" />
				        				<div class="input-group-append">
			        		...
			        		<div class="form-group row">
			        			...
			        			<label class="col-form-label text-right col-lg-3 col-sm-12">Tanggal Tugas</label>
			        			<div class="col-lg-3 col-sm-12">
			        				<div class="input-group date">
				        				<input type="text" autocomplete="off" class="form-control" id="kttanggallahir" name="reqTanggalLahir" placeholder="Select date" value="<?=$reqTanggalLahir?>" />
				        				<div class="input-group-append">
			        		...
			        		<div class="form-group row">
			        			...
			        			<label class="col-form-label text-left col-lg-1 col-sm-12">tahun</label>
			        			<div class="col-lg-1 col-sm-12">
			        				<input type="text" class="form-control" name="reqNama" id="reqNama" placeholder="" value="8" />
			        			</div>
			        			<label class="col-form-label text-left col-lg-1 col-sm-12">bulan</label>
			        		</div>	
		        		</div>
		        	</div>
