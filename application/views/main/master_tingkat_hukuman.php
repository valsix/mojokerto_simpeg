...
$arrtabledata= array(
    ...
    , array("label"=>"Nama", "field"=> "TINGKAT_HUKUMAN", "display"=>"",  "width"=>"")
    , array("label"=>"Peraturan Id", "field"=> "PERATURAN", "display"=>"",  "width"=>"")
   
    , array("label"=>"sorderdefault", "field"=> "SORDERDEFAULT", "display"=>"1", "width"=>"")
    , array("label"=>"fieldid", "field"=> "TINGKAT_HUKUMAN_ID", "display"=>"1", "width"=>"")
);
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/tingkat_hukuman_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/tingkat_hukuman_json/delete?reqId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/master_tingkat_hukuman_add?reqId="+vpilihid;
