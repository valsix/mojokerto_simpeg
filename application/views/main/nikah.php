...
$arrtabledata= array(
    array("label"=>"No. SK Cerai", "field"=> "SK_CERAI", "display"=>"",  "width"=>"")
    , array("label"=>"Tgl. SK Cerai", "field"=> "SK_CERAI_TANGGAL", "display"=>"",  "width"=>"")
    , array("label"=>"TMT SK Cerai", "field"=> "SK_CERAI_TMT", "display"=>"",  "width"=>"")
    , array("label"=>"Nama", "field"=> "NAMA", "display"=>"",  "width"=>"")
    , array("label"=>"PNS", "field"=> "NMPNS", "display"=>"",  "width"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/nikah_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/nikah_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/nikah_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
