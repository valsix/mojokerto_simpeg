...
$arrtabledata= array(
    ...
    , array("label"=>"Tingkat Hukuman", "field"=> "TINGKAT_HUKUMAN", "display"=>"",  "width"=>"")
    , array("label"=>"NAMA", "field"=> "JENIS_HUKUMAN", "display"=>"",  "width"=>"")
   
    , array("label"=>"sorderdefault", "field"=> "SORDERDEFAULT", "display"=>"1", "width"=>"")
    , array("label"=>"fieldid", "field"=> "JENIS_HUKUMAN_ID", "display"=>"1", "width"=>"")
);
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/jenis_hukuman_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/jenis_hukuman_json/delete?reqId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/master_jenis_hukuman_add?reqId="+vpilihid;
