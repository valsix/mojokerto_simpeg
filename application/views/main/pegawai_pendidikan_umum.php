...
jQuery(document).ready(function() {
    var jsonurl= "json-data/info_data_json/jsonpendidikanriwayat?reqPegawaiHard=<?=$reqPegawaiHard?>";
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/pegawai_pendidikan_umum_add?formulaid=<?=$formulaid?>&reqRowId="+vpilihid;
