...
{
	$set = new Diklat();
	$set->selectByParams(array('DIKLAT_ID'=>$reqId));
	// echo $set->query;exit;
	$set->firstRow();
	$reqId= $set->getField('DIKLAT_ID');
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-main/diklat_json/add";
					...
					success: function (response) {
                        ...
                        else
                        {
                            Swal.fire({
                                ...
                                document.location.href = "app/index/master_diklat";
