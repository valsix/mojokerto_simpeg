...
$this->load->model("base/Peraturan");
...
{
	$set = new Peraturan();
	$set->selectByParams(array('PERATURAN_ID'=>$reqId));
	// echo $set->query;exit;
	$set->firstRow();
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					<li class="breadcrumb-item text-muted">
						<a class="" href="app/index/master_peraturan"><?=$pgtitle?></a>
					</li>
					<li class="breadcrumb-item text-muted">
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-main/peraturan_json/add";
					...
					success: function (response) {
                        ...
                        else
                        {
                            Swal.fire({
                                ...
                                document.location.href = "app/index/master_peraturan";
