...
jQuery(document).ready(function() {
    var jsonurl= "json-main/pendidikan_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/pendidikan_json/delete?reqId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/master_pendidikan_add?reqId="+vpilihid;
