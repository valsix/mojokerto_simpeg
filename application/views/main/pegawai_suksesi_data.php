...
$statement= " AND INFOKEY = 'formulaid' AND A.RENCANA_SUKSESI_ID = ".$reqId;
$set= new InfoData();
$set->selectbyparamsrencanasuksesidetil(array(), -1,-1, $statement);
// echo $set->query;exit;
$set->firstRow();
$formulaid= $set->getField("INFOVAL");
// echo $formulaid;exit;
...
$set= new FormulaPenilaian();
$getformulapenilaianpendidikan= $set->getformulapenilaianpendidikan($formulaid, $reqPegawaiId);
...
$set= new FormulaPenilaian();
$getformulapenilaianjabatan= $set->getformulapenilaianjabatan($formulaid, $reqPegawaiId);
...
$set= new FormulaPenilaian();
$getformulapendidikanpelatihan= $set->getformulapendidikanpelatihan($formulaid, $reqPegawaiId);
...
$set= new FormulaPenilaian();
$getformulaketerlibatantim= $set->getformulaketerlibatantim($formulaid, $reqPegawaiId);
...
$statement= " and a.pegawai_id = ".$reqPegawaiId." and a.formula_penilaian_id = ".$formulaid;
$set= new FormulaPenilaian();
...
$statement= " AND A.FORMULA_PENILAIAN_ID = ".$formulaid;
$set= new FormulaPenilaian();
$arrnilai= [];
		        			...
		        			<table class="table table-bordered">
		        				...
		        				<tbody>
		        					...
		        					<tr>
		        						...
		        						<td rowspan="<?=$jumlahheadrow?>"><?=$jenisnilai?></td>
		        					</tr>
		        					<?
		        						if($jumlahrow > 1)
			        					{
