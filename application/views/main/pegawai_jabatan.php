...
$arrtabledata= array(
    // array("label"=>"fieldid", "field"=> "RIWAYAT_JABATAN_ID", "display"=>"",  "width"=>""),
    array("label"=>"Nama Jabatan", "field"=> "JABATAN", "display"=>"",  "width"=>"")
    , array("label"=>"TMT Jabatan", "field"=> "TMT_JABATAN", "display"=>"",  "width"=>"")
    , array("label"=>"Eselon", "field"=> "ESELON_NAMA", "display"=>"",  "width"=>"")
    , array("label"=>"Masa Kerja Tahun", "field"=> "MASA_JAB_TAHUN", "display"=>"",  "width"=>"")
    , array("label"=>"Masa Kerja Bulan", "field"=> "MASA_JAB_BULAN", "display"=>"", "width"=>"")
    // , array("label"=>"Pejabat Penetap", "field"=> "PEJABAT_PENETAP", "display"=>"",  "width"=>"")
    // , array("label"=>"TMT Mutasi", "field"=> "TMT_ESELON", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "RIWAYAT_JABATAN_ID", "display"=>"1", "width"=>"")
);
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a class="text-muted">Pegawai Jabatan</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Pegawai Jabatan</h3>
                </div>
...
jQuery(document).ready(function() {
    var jsonurl= "json-data/info_data_json/jsonpegawaijabatan";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-data/info_data_json/jsonjabatanriwayatdelete?&reqDetilId="+valinfoid;
            swal.fire({
                    ...
                    $.ajax({
                        ...
                        success : function(data) { 
                            swal.fire({
                                ...
                                document.location.href = "app/index/pegawai_jabatan?formulaid=<?=$formulaid?>";
                            });
                        },
                        complete: function() {
                            swal.hideLoading();
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/pegawai_jabatan_add?formulaid=<?=$formulaid?>&reqRowId="+vpilihid;
