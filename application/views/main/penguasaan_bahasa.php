...
jQuery(document).ready(function() {
    var jsonurl= "json-main/penguasaan_bahasa_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/penguasaan_bahasa_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/penguasaan_bahasa_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
