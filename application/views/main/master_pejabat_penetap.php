...
$arrtabledata= array(
    ...
    , array("label"=>"NIP", "field"=> "NIP", "display"=>"",  "width"=>"")
    , array("label"=>"Jabatan", "field"=> "JABATAN", "display"=>"",  "width"=>"")
   
    , array("label"=>"sorderdefault", "field"=> "SORDERDEFAULT", "display"=>"1", "width"=>"")
    , array("label"=>"fieldid", "field"=> "PEJABAT_PENETAP_ID", "display"=>"1", "width"=>"")
);
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/pejabat_penetap_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/pejabat_penetap_json/delete?reqId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/master_pejabat_penetap_add?reqId="+vpilihid;
