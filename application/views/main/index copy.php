                                    ...
                                    <nav class="navbar navbar-default">
                                        <div class="container-fluid">
                                            <div class="navbar-header">
                                                <button type="button" class="navbar-toggle collapsed btn btn-warning" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">Menu FIP
                                            ...
                                            <div id="navbar" class="navbar-collapse collapse">
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pengangkatan <span class="caret"></span></a>
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pangkat/Gaji <span class="caret"></span></a>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="#">Link</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Jab/Tugas <span class="caret"></span></a>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="#">Link</a></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Diklat <span class="caret"></span></a>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="#">Link</a></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Keluarga <span class="caret"></span></a>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="#">Link</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="#">Huk. Disiplin</a></li>
