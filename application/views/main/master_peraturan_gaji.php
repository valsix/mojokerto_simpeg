...
$arrtabledata= array(
    ...
    , array("label"=>"Status", "field"=> "STATUS_AKTIF", "display"=>"",  "width"=>"")
   
    , array("label"=>"sorderdefault", "field"=> "SORDERDEFAULT", "display"=>"1", "width"=>"")
    , array("label"=>"fieldid", "field"=> "GAJI_PERATURAN_ID", "display"=>"1", "width"=>"")
);
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="dropdown dropdown-inline mr-2">
                        ...
                        <button class="btn btn-light-success" id="btnAktif"><i class="fa fa-toggle-on" aria-hidden="true"></i> Set Aktif</button>
...
$('#btnAktif').on('click', function () {
    if(valinfoid == "")
        return false;
    if ( confirm( "Apakah anda yakin, mengaktifkan data ini ?" ) ) {
        var data="";
        $.ajax({
            url: 'json-main/peraturan_gaji_json/delete/?reqMode=aktif&reqId='+valinfoid,
            type: 'GET',
            ...
            success: function(res) {
                if(res.status==true)
                {
                     document.location.href = "app/index/master_peraturan_gaji";
                }
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/peraturan_gaji_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/peraturan_gaji_json/delete?reqId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/master_peraturan_gaji_add?reqId="+vpilihid;
