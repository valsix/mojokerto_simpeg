...
$arrtabledatath2= array(
     array("label"=>"IIA", "field"=> "TOT21", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"IIB", "field"=> "TOT22", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"IIIA", "field"=> "TOT31", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"IIIB", "field"=> "TOT32", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"IVA", "field"=> "TOT41", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"IVB", "field"=> "TOT42", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"VA", "field"=> "TOT51", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"VB", "field"=> "TOT52", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/report_json/json_rekap_eselon_jabatan?reqId=<?=$reqId?>";
    ...
    $("#reqPeriode").change(function() { 
        jsonurl= "json-main/report_json/json_rekap_eselon_jabatan?reqSatkerId=<?=$reqId?>&reqPeriode=" + $("#reqPeriode").val()+"&reqTahun=" + $("#reqTahun").val();
    ...
    $("#btnCetak").on("click", function () {
        ...
        varurl= "json-main/cetak_report_json/eselon_jabatan?reqPeriode="+reqPeriode+"&reqTahun="+reqTahun;
