...
$arrtabledata= array(
    ...
    , array("label"=>"TMT Tugas Tambahan", "field"=> "TMT_TUGAS_TAMBAHAN", "display"=>"",  "width"=>"")
    , array("label"=>"No Pelantikan", "field"=> "NO_PELANTIKAN", "display"=>"",  "width"=>"")
    , array("label"=>"Tgl Pelantikan", "field"=> "TANGGAL_PELANTIKAN", "display"=>"",  "width"=>"")
    , array("label"=>"Tunjangan", "field"=> "TUNJANGAN", "display"=>"",  "width"=>"")
    , array("label"=>"Bln Dibayar", "field"=> "BULAN_DIBAYAR", "display"=>"",  "width"=>"")
    , array("label"=>"Perpanjangan BUP", "field"=> "KETERANGAN_BUP", "display"=>"",  "width"=>"")
    , array("label"=>"Angka Kredit", "field"=> "ANGKA_KREDIT", "display"=>"",  "width"=>"")
    , array("label"=>"Tentang Jabatan", "field"=> "TENTANG_JABATAN", "display"=>"",  "width"=>"")
    , array("label"=>"Jenis Jabatan", "field"=> "JENIS_JABATAN", "display"=>"",  "width"=>"")
    , array("label"=>"Kode Jabatan", "field"=> "KODE_JABATAN", "display"=>"",  "width"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "JABATAN_RIWAYAT_ID", "display"=>"1", "width"=>"")
);
?>
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/riwayat_jabatan_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
           urlAjax= "json-main/riwayat_jabatan_json/delete?reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/riwayat_jabatan_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
