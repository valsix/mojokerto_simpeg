...
{
	$set= new PelatihanFungsional();
	$set->selectByParams(array('DIKLAT_FUNGSIONAL_ID'=>$reqRowId));
	$set->firstRow();
	$reqDIKLAT_FUNGSIONAL_ID = $set->getField('DIKLAT_FUNGSIONAL_ID');
...
$riwayattable= "DIKLAT_FUNGSIONAL";
		        ...
		        <div class="card-body">
	        		...
	        		?>
		        		<div class="form-group row">
		        			<label class="col-form-label text-right col-lg-2 col-sm-12">Nama Pelatihan</label>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-main/pelatihan_fungsional_json/add";
