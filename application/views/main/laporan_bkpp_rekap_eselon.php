...
$arrtabledatath1= array(
    ...
    , array("label"=>"ESELON", "field"=> "", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"5")
);

$arrtabledatath2= array(
     array("label"=>"JML II", "field"=> "TOT2", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"JML III", "field"=> "TOT3", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"JML IV", "field"=> "TOT4", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
    , array("label"=>"JML V", "field"=> "TOT5", "display"=>"",  "width"=>"", "rowspan"=>"", "colspan"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/report_json/json_rekap_eselon_terisi?reqId=<?=$reqId?>";
    ...
    $("#btnCetak").on("click", function () {
        ...
        varurl= "json-main/cetak_report_json/eselon_terisi?reqPeriode="+reqPeriode+"&reqTahun="+reqTahun;
