...
$arrtabledata= array(
    ...
    , array("label"=>"Lama", "field"=> "LAMA", "display"=>"",  "width"=>"")
...
jQuery(document).ready(function() {
    var jsonurl= "json-main/cuti_json/json?reqId=<?=$reqId?>";
    ...
    $('#btnDelete').on('click', function (e) {
        ...
        {
            urlAjax= "json-main/cuti_json/delete?&reqRowId="+valinfoid;
            swal.fire({
    ...
    $("#btnAdd, #btnUbahData").on("click", function () {
        ...
        varurl= "app/index/cuti_add?reqRowId="+vpilihid+"&reqId=<?=$reqId?>";
