...
{
	$judul="Jabatan Struktural";
	$link="templates/jabatan_struktural.xls";
}
else if ($reqJenisJabatan == 2)
{
	$judul="Jabatan Fungsional";
	$link="templates/jabatan_fungsional.xls";
}
else if ($reqJenisJabatan == 3)
{
	$judul="Jabatan Pelaksana";
	$link="templates/jabatan_pelaksana.xls";
}
else if ($reqJenisJabatan == 4)
{
	$judul="Fungsional dengan tambahan";
	$link="templates/jabatan_fungsional_tambahan.xls";
}
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		var formSubmitUrl = "json-admin/import_json/import_jabatan";
				...
				$.ajax({
					...
					success: function (response) {
			        	...
			        	Swal.fire({
			        		...
			        		document.location.href = "admin/index/riwayat_jabatan";
