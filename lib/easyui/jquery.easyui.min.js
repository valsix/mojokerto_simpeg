...
if(typeof $.data(_8b2,"combobox") == "undefined"){}
else
{
var opts=$.data(_8b2,"combobox").options;
}

if(typeof $(_8b2).combo("panel") == "undefined"){}
else
{
...
//one
if(typeof $.data(_8bd,"combobox") == "undefined"){}
else
{
...
if(typeof $.data(this,"combotree") == "undefined"){}
else
{
var opts=$.data(this,"combotree").options;
var tree=$.data(this,"combotree").tree;
