...
(function(n) {
    n(["jquery"], function(n) {
        ...
        function k(t, u, f) {
            ...
            var o = '<div class=modal-body style="position: absolute;width: 100%;background-color: rgba(255,255,255,0.8);height: 100%;">%1%<\/div><iframe class="embed-responsive-item" src="%0%" style="width:100%;height:calc(100vh - 120px);"/>'.replace("%0%", t.message || t.url || t).replace("%1%", i.loadingHtml),
                e = n(o).load(s);
            return r({
                buttons: t.buttons || !1,
                message: e,
