...
(function(n) {
    n(["jquery"], function(n) {
        ...
        function rt() {
            function i() {
                return n('<div class="modal fade" tabindex="-1"><div class="modal-dialog" style="width:calc(100% - 40px) !important;"><div class=modal-content style="border:4px solid #feb856; border-radius:10px !important;"> <div class=modal-header style="background:rgba(254,184,86,1) !important;"><button type=button class="x close" data-dismiss=modal style="background:#FFF !important; color:#feb856 !important;"><span aria-hidden=true>&times;<\/span><span class=sr-only>Close<\/span><\/button><h4 class=modal-title style="margin-right:40px; background-color:transparent !important;"><\/h4><\/div><\/div><\/div><\/div>').on("hidden.bs.modal", v).on("click", "button.x", function(i) {
    ...
    typeof module != "undefined" && window.module.exports ? window.module.exports = t(window.require(n[0])) : window.eModalSemiFull = t(window.jQuery)
});